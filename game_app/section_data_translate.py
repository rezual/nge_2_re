...
section_data = AppSection('.data', 0x001DAA00, 0x000793FC, AppSectionFlag.Allocated | AppSectionFlag.Writable,
{
    ...
    0x00239C0C: Data(DataType.String, 16, '???', "地下方向へ進む\0"),
    0x00239C1C: Data(DataType.String, 16, '???', "薄暗い方へ進む\0"),
    0x00239C2C: Data(DataType.String, 24, '???', "機械音がする方向へ進む\0"),
    0x00239C44: Data(DataType.String, 20, '???', "次の角を左に曲がる\0"),
    0x00239C58: Data(DataType.String, 20, '???', "次の角を右に曲がる\0"),
    0x00239C6C: Data(DataType.String, 12, '???', "梯子を登る\0"),
    0x00239C78: Data(DataType.String, 16, '???', "梯子を降りる\0"),
    0x00239C88: Data(DataType.String, 20, '???', "扉を無視して進む\0"),
    0x00239C9C: Data(DataType.String, 28, '???', "セキュリティー扉を開ける\0"),
    ...
    0x002504F4: Data(DataType.String, 12, '???', "キャンセル\0"),
    0x00250500: Data(DataType.String, 28, '???', "アンビリカルケーブル接続\0"),
    0x0025051C: Data(DataType.String, 16, '???', "武器を装備する\0"),
    0x0025052C: Data(DataType.String, 24, '???', "全域マップを確認する\0"),
    0x00250544: Data(DataType.String, 20, '???', "ミドルキックで攻撃\0"),
    0x00250558: Data(DataType.String, 20, '???', "ブログナイフで突く\0"),
    0x00250570: Data(DataType.String, 16, '???', "チョップ攻撃\0"),
    0x00250580: Data(DataType.String, 20, '???', "プログナイフで切る\0"),
    0x00250598: Data(DataType.String, 24, '???', "フロントキックで攻撃\0"),
    0x002505B4: Data(DataType.String, 12, '???', "剣を振るう\0"),
    0x002505C0: Data(DataType.String, 24, '???', "ΑΤフィールドアタック\0"),
    0x002505D8: Data(DataType.String, 20, '???', "ツープラトンキック\0"),
    0x002505EC: Data(DataType.String, 24, '???', "パレットライフルで射撃\0"),
    0x00250604: Data(DataType.String, 24, '???', "マゴロクソードで斬る\0"),
    0x0025061C: Data(DataType.String, 24, '???', "マゴロクソードで突く\0"),
    0x00250634: Data(DataType.String, 16, '???', "ライフルで射撃\0"),
    0x00250644: Data(DataType.String, 28, '???', "ポジトロンライフルで射撃\0"),
    0x00250660: Data(DataType.String, 24, '???', "ポジトロン・Ｓで射撃\0"),
    0x00250678: Data(DataType.String, 20, '???', "ケーブルを切断する\0"),
    ...
    0x0025071C: Data(DataType.String, 16, '???', "マステマで射撃\0"),
    0x0025072C: Data(DataType.String, 16, '???', "マステマで切る\0"),
    0x0025073C: Data(DataType.String, 16, '???', "Νミサイル攻撃\0"),
    0x0025074C: Data(DataType.String, 20, '???', "デュアルソーで攻撃\0"),
    0x00250760: Data(DataType.String, 20, '???', "プログダガーで突く\0"),
    0x00250774: Data(DataType.String, 20, '???', "プログダガーで切る\0"),
    0x00250788: Data(DataType.String, 20, '???', "インパクトボルト\0"),
    0x0025079C: Data(DataType.String, 20, '???', "ハイパーチョップ\0"),
    0x002507B0: Data(DataType.String, 20, '???', "タブリスと対話する\0"),
    0x002507C4: Data(DataType.String, 20, '???', "パイロットに指示\0"),
    0x002507D8: Data(DataType.String, 16, '???', "神経接続切断\0"),
    0x002507E8: Data(DataType.String, 12, '???', "ステータス\0"),
    ...
    0x00250860: Data(DataType.String, 12, '???', "作戦決定\0"),
    0x0025086C: Data(DataType.String, 28, '???', "パイロット選択からやり直す\0"),
    0x00250888: Data(DataType.String, 20, '???', "ダミープラグを使え\0"),
    0x0025089C: Data(DataType.String, 24, '???', "ロンギヌスの槍を使え\0"),
    0x002508B4: Data(DataType.String, 20, '???', "神経接続を切断する\0"),
    0x002508C8: Data(DataType.String, 20, '???', "%sにダミープラグだ\0"),
    0x002508DC: Data(DataType.String, 12, '???', "パンチ攻撃\0"),
    0x002508E8: Data(DataType.String, 16, '???', "ネルフに戻る\0"),
    ...
    0x00250924: Data(DataType.String, 28, '???', "アンビリカルケーブル切断\0"),
    ...
    0x002509F8: Data(DataType.String, 8, '???', "はい\0"),
    0x00250A00: Data(DataType.String, 8, '???', "いいえ\0"),
    ...
    0x00250ACC: Data(DataType.String, 40, '???', "ＥＶＡは３体までしか\n出撃できません。\0"),
    ...
    0x00250BE8: Data(DataType.String, 48, '???', "出撃するエヴァのパイロットを\n選んでください。\0"),
    ...
    0x00252958: Data(DataType.String, 20, '???', "ＡＴフィールド持続\0"),
    ...
    0x00252C40: Data(DataType.String, 16, '???', "ガギエルの開口\0"),
