...
section_data = AppSection('.data', 0x001DAA00, 0x000793FC, AppSectionFlag.Allocated | AppSectionFlag.Writable,
{
    ...
    0x00239D78: Data(DataType.String, 28, 'Huh, I came out in such a place.\0', "あれ、こんなとこに出た。\0"),
    ...
    0x00250604: Data(DataType.String, 24, 'Magoroku Sword Slash\0', "マゴロクソードで斬る\0"),
    0x0025061C: Data(DataType.String, 24, 'Magoroku Sword Thrust\0', "マゴロクソードで突く\0"),
    ...
    0x0025068C: Data(DataType.String, 16, 'Use equipment\0', "装備を実行する\0"),
    ...
    0x0025086C: Data(DataType.String, 28, 'Redo from pilot selection\0', "パイロット選択からやり直す\0"),
    ...
    0x002509B4: Data(DataType.String, 24, 'Strategy planning finished, continue\0', "作戦立案終了、次に進む\0"),
    ...
    0x00250C54: Data(DataType.String, 48, 'The pilot is currently missing\nso it can\'t sortie.\0', "現在、パイロットが欠番のため\n出撃出来ません。\0"),
    ...
    0x00250D08: Data(DataType.String, 72, 'If you place the Eva here\nit can only be active for %sminutes.\nPlace it anyways?\0', "ここにエヴァを配置すると、\n%s分間しか活動出来ません。\n配置しますか？\0"),
