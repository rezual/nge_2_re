...
#          Settings -> Tools -> Developer Tools -> CPU Core -> Interpreter (NOT the IR one, just the regular interpreter)
#     if you don't do this, expect weird bugs! 
#     (It should be noted that breakpoints don't work in the interpreter core for those considering using PPSSPP's debugger)
#     
...
#
# Bugs: 
# - Some things are untranslated possibly because the game does direct string operations instead
#   of relying on strcpy and related functions. I'm hooking these functions as I find them
# - Some menus crash or cause corruption because the game doesn't know what to do with the longer text
#
...
# Half-width patch
NEW_HALFWIDTH_START_ADDRESS = NEW_088742DC_ADDRESS
