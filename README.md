...
- Text in Read-Only Section of Game Executable:
	- [ ] 56.19% translated - See game_app/section_rodata_translate.py
...
- umd0:/PSP_GAME/USRDIR/*.evs:
	- [ ] 11.38% translated (in total)
		- [ ] 14.54% translated - See game_data/files_evs_part_1.py
		- [ ] 8.66% translated - See game_data/files_evs_part_2.py
		- [ ] 10.95% translated - See game_data/files_evs_part_3.py
