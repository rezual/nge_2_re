...
- Text in Read-Only Section of Game Executable:
	- [ ] 41.90% translated - See game_app/section_rodata_translate.py
...
- umd0:/PSP_GAME/USRDIR/*.evs:
	- [ ] 0.00% translated (in total)
		- [ ] 0.00% translated - See game_data/files_evs_part_1.py
		- [ ] 0.00% translated - See game_data/files_evs_part_2.py
		- [ ] 0.00% translated - See game_data/files_evs_part_3.py
- umd0:/PSP_GAME/USRDIR/btl/btimtext.bin:
	- [ ] 25.09% translated - See game_data/file_btimtext_translate.py
