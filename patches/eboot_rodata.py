...
section_rodata = AppSection('.rodata', 0x001B0640, 0x0002A3A0, AppSectionFlag.Allocated,
{
    ...
    0x001B6078: Data(DataType.String, 44, '???', "所持していると、体調が低下しなくなります。"),
    0x001B60A4: Data(DataType.String, 12, 'Timid Spirit', "小心の精神"),
    0x001B60B0: Data(DataType.String, 12, 'Expert Technique', "達人の技法"),
    0x001B60BC: Data(DataType.String, 40, '???', "使うと、全ての技能が最大値になります。"),
    0x001B60E4: Data(DataType.String, 32, '???', "全ての技能が最高値になった！"),
    0x001B6104: Data(DataType.String, 12, 'Alchemical Technique', "錬金の技法"),
    0x001B6110: Data(DataType.String, 36, '???', "使うと、所持金が１０万円増えます。"),
    0x001B6134: Data(DataType.String, 28, '???', "所持金が１０万円増えた！"),
    0x001B6150: Data(DataType.String, 12, 'Mere Words', "許しの言葉"),
    0x001B615C: Data(DataType.String, 32, '???', "使うと、全員の関心が高くなる。"),
    0x001B617C: Data(DataType.String, 28, '???', "みんなの関心が高くなった！"),
    0x001B6198: Data(DataType.String, 12, 'Sickness Unto Death', "死に至る病"),
    0x001B61A4: Data(DataType.String, 36, '???', "使うと、全員のΑΤが減少します。"),
    0x001B61C8: Data(DataType.String, 24, '???', "全員のΑΤが減少した！"),
    0x001B61E0: Data(DataType.String, 12, 'Words of Solace', "癒しの言葉"),
    0x001B61EC: Data(DataType.String, 32, '???', "使うと、全員の好意が高くなる。"),
    0x001B620C: Data(DataType.String, 28, '???', "みんなの好意が高くなった！"),
    0x001B6228: Data(DataType.String, 16, 'Complemented Heart', "補完された心"),
    0x001B6238: Data(DataType.String, 36, '???', "使うと、全員のΑΤが増加します。"),
    0x001B625C: Data(DataType.String, 24, 'Everyone\'s A.T. went up!', "全員のΑΤが増加した！"),
    0x001B6274: Data(DataType.String, 20, '???', "生爪特製ストラップ"),
    ...
    0x001B6B00: Data(DataType.String, 8, '???', "？？？"),
    ...
    0x001BC5E8: Data(DataType.String, 12, '???', " 場-%d.%d"),
    0x001BC5F4: Data(DataType.String, 8, '???', " 予-%d"),
    ...
    0x001BC724: Data(DataType.String, 16, '???', "%d回目の思考"),
    ...
    0x001BC77C: Data(DataType.String, 8, '???', "再選×"),
    0x001BC784: Data(DataType.String, 8, 'Population:', "人口×"),
    0x001BC78C: Data(DataType.String, 8, '???', "跨×"),
    0x001BC794: Data(DataType.String, 8, '???', "マ×"),
    0x001BC79C: Data(DataType.String, 8, '???', "移のみ"),
    ...
    0x001BE550: Data(DataType.String, 16, '???', "どうしたの？"),
    0x001BE560: Data(DataType.String, 12, '???', "グエと鳴く"),
    0x001BE56C: Data(DataType.String, 24, '???', "かわいいしぐさをする"),
    0x001BE584: Data(DataType.String, 16, '???', "かわいいと言う"),
    0x001BE594: Data(DataType.String, 12, '???', "わからない"),
    0x001BE5A0: Data(DataType.String, 12, '???', "資料を渡す"),
    0x001BE5AC: Data(DataType.String, 12, '???', "情報を話す"),
    0x001BE5B8: Data(DataType.String, 12, '???', "話をせがむ"),
    0x001BE5C4: Data(DataType.String, 20, '???', "会話で気分転換する"),
    0x001BE5D8: Data(DataType.String, 12, '???', "話さない"),
    0x001BE5E4: Data(DataType.String, 12, '???', "気持ちいい"),
    ...
    0x001BE6C4: Data(DataType.String, 20, '???', "状況の不安さを語る"),
    ...
    0x001BEA0C: Data(DataType.String, 24, '???', "気を引き締めるよう忠告"),
    0x001BEA24: Data(DataType.String, 24, '???', "先行きの暗さをもらす"),
    0x001BEA3C: Data(DataType.String, 24, '???', "なんとかするよう責める"),
    0x001BEA54: Data(DataType.String, 24, '???', "絶望の気持ちをぶつける"),
    0x001BEA6C: Data(DataType.String, 20, '???', "楽勝であったと言う"),
    0x001BEA80: Data(DataType.String, 24, '???', "苦労せず勝てたと言う"),
    0x001BEA98: Data(DataType.String, 24, '???', "がんばったからと言う"),
    0x001BEAB0: Data(DataType.String, 24, '???', "苦戦は強いられたと言う"),
    0x001BEAC8: Data(DataType.String, 24, '???', "がんばったけど…と言う"),
    0x001BEAE0: Data(DataType.String, 24, '???', "だいぶやられたと言う"),
    0x001BEAF8: Data(DataType.String, 24, '???', "もう戦いたくないと言う"),
    0x001BEB10: Data(DataType.String, 20, '???', "弱気な態度を見せる"),
    ...
    0x001BEC28: Data(DataType.String, 24, '???', "もっと寂しくなりそう"),
    ...
    0x001BEDA0: Data(DataType.String, 12, '???', "泣き崩れる"),
    0x001BEDAC: Data(DataType.String, 16, '???', "言葉に詰まる"),
    0x001BEDBC: Data(DataType.String, 16, '???', "死にそうな顔"),
    0x001BEDCC: Data(DataType.String, 24, '???', "そんな話聞きたくない"),
    0x001BEDE4: Data(DataType.String, 12, '???', "カラ元気"),
    0x001BEDF0: Data(DataType.String, 24, '???', "疎開する生徒増加の話題"),
    0x001BEE08: Data(DataType.String, 24, '???', "疎開で生徒激減の話題"),
    0x001BEE20: Data(DataType.String, 24, '???', "コンビニの品揃えの話題"),
    0x001BEE38: Data(DataType.String, 28, '???', "コンビニに商品が無い話題"),
    0x001BEE54: Data(DataType.String, 24, '???', "希望的観測を口にする"),
    0x001BEE6C: Data(DataType.String, 28, '???', "ヒカリの姉妹が死んだ話題"),
    0x001BEE88: Data(DataType.String, 24, '???', "トウジが疎開した話題"),
    0x001BEEA0: Data(DataType.String, 24, '???', "ケンスケが疎開した話題"),
    0x001BEEB8: Data(DataType.String, 24, '???', "ヒカリが疎開した話題"),
    0x001BEED0: Data(DataType.String, 28, '???', "レイのアパート倒壊の話題"),
    0x001BEEEC: Data(DataType.String, 12, '???', "絶句する"),
    0x001BEEF8: Data(DataType.String, 20, '???', "悲しく相づちをうつ"),
    0x001BEF0C: Data(DataType.String, 24, '???', "寂しくなるね、と言う"),
    0x001BEF24: Data(DataType.String, 12, 'Bring up the weather', "天気の話題"),
    0x001BEF30: Data(DataType.String, 12, '???', "共感する"),
    0x001BEF3C: Data(DataType.String, 12, '???', "反対の意見"),
    ...
    0x001BEF84: Data(DataType.String, 20, '???', "宿題の存在に驚く"),
    0x001BEF98: Data(DataType.String, 28, 'Ask Toji how his sister\'s doing', "トウジに妹の様子を尋ねる"),
    0x001BEFB4: Data(DataType.String, 20, '???', "調子がいいと答える"),
    0x001BEFC8: Data(DataType.String, 20, '???', "ぼちぼちだと答える"),
    0x001BEFDC: Data(DataType.String, 12, '???', "押し黙る"),
    0x001BEFE8: Data(DataType.String, 20, 'Ask about Misato', "ミサトについて聞く"),
    0x001BEFFC: Data(DataType.String, 16, '???', "ミサトを誉める"),
    0x001BF00C: Data(DataType.String, 24, '???', "ミサトはいい人だと言う"),
    0x001BF024: Data(DataType.String, 24, '???', "とくに言うことはない"),
    0x001BF03C: Data(DataType.String, 20, '???', "ミサトを軽くけなす"),
    0x001BF050: Data(DataType.String, 24, '???', "ミサトへの不満を表す"),
    0x001BF068: Data(DataType.String, 16, '???', "相づちをうつ"),
    ...
    0x001BF0AC: Data(DataType.String, 12, '???', "興味ない"),
    0x001BF0B8: Data(DataType.String, 16, '???', "加持をけなす"),
    0x001BF0C8: Data(DataType.String, 24, '???', "加持をけなされムカツク"),
    0x001BF0E0: Data(DataType.String, 20, '???', "加持をけなされ驚く"),
    0x001BF0F4: Data(DataType.String, 28, '???', "加持への不満を爆発させる"),
    0x001BF110: Data(DataType.String, 20, '???', "アスカに同意する"),
    ...
    0x001BF150: Data(DataType.String, 20, '???', "好調であると答える"),
    0x001BF164: Data(DataType.String, 20, '???', "普通であると答える"),
    0x001BF178: Data(DataType.String, 20, '???', "調子が悪いと答える"),
    0x001BF18C: Data(DataType.String, 20, 'Ask how things are at school', "学校の様子を尋ねる"),
    0x001BF1A0: Data(DataType.String, 16, '???', "楽しいと答える"),
    0x001BF1B0: Data(DataType.String, 20, '???', "楽しくないと答える"),
    0x001BF1C4: Data(DataType.String, 16, '???', "発破をかける"),
    0x001BF1D4: Data(DataType.String, 16, '???', "気休めを言う"),
    0x001BF1E4: Data(DataType.String, 24, 'Ask how busy work is', "仕事の忙しさを尋ねる"),
    0x001BF1FC: Data(DataType.String, 24, '???', "仕事は楽にこなしている"),
    0x001BF214: Data(DataType.String, 24, '???', "残業なしでやれている"),
    0x001BF22C: Data(DataType.String, 16, '???', "特に問題は無い"),
    0x001BF23C: Data(DataType.String, 20, '???', "残業が増えている"),
    0x001BF250: Data(DataType.String, 12, '???', "多忙で大変"),
    0x001BF25C: Data(DataType.String, 20, 'Ask about Nerv', "ネルフについて質問"),
    0x001BF270: Data(DataType.String, 20, '???', "ネルフについて返答"),
    ...
    0x001BF2D4: Data(DataType.String, 20, '???', "答えをはぐらかす"),
    0x001BF2E8: Data(DataType.String, 28, 'Ask about Human Instrumentality Project', "人類補完計画について質問"),
    0x001BF304: Data(DataType.String, 28, '???', "人類補完計画について返答"),
    0x001BF320: Data(DataType.String, 24, 'Ask about Gendo', "ゲンドウについて尋ねる"),
    0x001BF338: Data(DataType.String, 20, '???', "立派な人だと教える"),
    0x001BF34C: Data(DataType.String, 20, '???', "忙しい人だと教える"),
    0x001BF360: Data(DataType.String, 24, '???', "最低の上司だと教える"),
    0x001BF378: Data(DataType.String, 24, '???', "よくわからないと教える"),
    0x001BF390: Data(DataType.String, 20, '???', "父の評価に相づち"),
    0x001BF3A4: Data(DataType.String, 24, '???', "シンジの態度につっこむ"),
    0x001BF3BC: Data(DataType.String, 20, '???', "しどろもどろになる"),
    0x001BF3D0: Data(DataType.String, 24, 'Hear how pilots are doing', "パイロットの様子を聞く"),
    0x001BF3E8: Data(DataType.String, 16, '???', "順風満帆である"),
    0x001BF3F8: Data(DataType.String, 12, '???', "順調である"),
    0x001BF404: Data(DataType.String, 24, '???', "可も無く、不可も無く"),
    0x001BF41C: Data(DataType.String, 24, '???', "問題が無いわけではない"),
    0x001BF434: Data(DataType.String, 20, '???', "困難な事態である"),
    ...
    0x001BF4EC: Data(DataType.String, 24, '???', "核心に近づきつつある"),
    0x001BF504: Data(DataType.String, 20, '???', "身の危険をつぶやく"),
    0x001BF518: Data(DataType.String, 28, 'Request printed report', "プリントの届けを依頼する"),
    0x001BF534: Data(DataType.String, 16, '???', "プリントを託す"),
    ...
    0x001BF5C8: Data(DataType.String, 20, '???', "受動者の退院を喜ぶ"),
    0x001BF5DC: Data(DataType.String, 28, '???', "調子が良さそうに返事する"),
    0x001BF5F8: Data(DataType.String, 16, '???', "普通に返事する"),
    0x001BF608: Data(DataType.String, 24, '???', "調子が悪そうに返事する"),
    0x001BF620: Data(DataType.String, 20, '???', "気さくに応答する"),
    0x001BF634: Data(DataType.String, 16, '???', "普通に応答する"),
    0x001BF644: Data(DataType.String, 24, '???', "ぶっきらぼうに応答する"),
    ...
    0x001BF6A0: Data(DataType.String, 24, '???', "緊張している様子を指摘"),
    0x001BF6B8: Data(DataType.String, 24, '???', "安心している様子を指摘"),
    0x001BF6D0: Data(DataType.String, 20, '???', "不安な様子を指摘"),
    0x001BF6E4: Data(DataType.String, 24, '???', "悲しんでいる様子を指摘"),
    0x001BF6FC: Data(DataType.String, 28, '???', "気が緩んでいる様子を指摘"),
    0x001BF718: Data(DataType.String, 24, '???', "落胆している様子を指摘"),
    0x001BF730: Data(DataType.String, 20, '???', "不愉快な様子を指摘"),
    0x001BF744: Data(DataType.String, 24, '???', "怒っている様子を指摘"),
    0x001BF75C: Data(DataType.String, 20, 'Mention their flushed face', "顔のほてりを指摘"),
    0x001BF770: Data(DataType.String, 24, '???', "恥らっている様子を指摘"),
    0x001BF788: Data(DataType.String, 16, '???', "明るく肯定する"),
    0x001BF798: Data(DataType.String, 16, '???', "明るくごまかす"),
    0x001BF7A8: Data(DataType.String, 16, '???', "明るく否定する"),
    0x001BF7B8: Data(DataType.String, 12, 'Affirm', "肯定する"),
    0x001BF7C4: Data(DataType.String, 12, '???', "ごまかす"),
    0x001BF7D0: Data(DataType.String, 12, '???', "否定する"),
    0x001BF7DC: Data(DataType.String, 20, '???', "気まずく肯定する"),
    0x001BF7F0: Data(DataType.String, 20, '???', "気まずくごまかす"),
    0x001BF804: Data(DataType.String, 20, '???', "気まずく否定する"),
    0x001BF818: Data(DataType.String, 24, '???', "沈んだ様子で肯定する"),
    0x001BF830: Data(DataType.String, 24, '???', "沈んだ様子でごまかす"),
    0x001BF848: Data(DataType.String, 24, '???', "沈んだ様子で否定する"),
    0x001BF860: Data(DataType.String, 24, '???', "そんな言い方やめてよ"),
    0x001BF878: Data(DataType.String, 16, 'S-say what?', "そ、そんな…"),
    0x001BF888: Data(DataType.String, 24, '???', "恥じらいながら否定する"),
    0x001BF8A0: Data(DataType.String, 24, '???', "さりげなく切り上げる"),
    0x001BF8B8: Data(DataType.String, 20, '???', "気まずく切り上げる"),
    ...
    0x001BFB24: Data(DataType.String, 20, '???', "応答して立ち上がる"),
    0x001BFB38: Data(DataType.String, 12, '???', "追い払う"),
    0x001BFB44: Data(DataType.String, 16, 'Sit on bench', "ベンチに座る"),
    0x001BFB54: Data(DataType.String, 24, 'Rise from bench', "ベンチから立ち上がる"),
    0x001BFB6C: Data(DataType.String, 28, '???', "ベンチでぼんやりくつろぐ"),
    ...
    0x001BFC2C: Data(DataType.String, 20, '???', "テストに集中する"),
    0x001BFC40: Data(DataType.String, 12, '???', "無心を保つ"),
    0x001BFC4C: Data(DataType.String, 24, '???', "エヴァに意識を向ける"),
    0x001BFC64: Data(DataType.String, 16, '???', "自然体で臨む"),
    0x001BFC74: Data(DataType.String, 16, 'Relax', "リラックスする"),
    0x001BFC84: Data(DataType.String, 16, '???', "落ち着かない"),
    0x001BFC94: Data(DataType.String, 16, '???', "やる気が出ない"),
    0x001BFCA4: Data(DataType.String, 24, '???', "テストの結果に満足する"),
    0x001BFCBC: Data(DataType.String, 28, '???', "平凡な成績であると伝える"),
    0x001BFCD8: Data(DataType.String, 20, '???', "テストの結果を叱る"),
    0x001BFCEC: Data(DataType.String, 24, 'Request Synch Skill Training', "シンクロ技能訓練の依頼"),
    0x001BFD04: Data(DataType.String, 16, '???', "参謀技能の訓練"),
    0x001BFD14: Data(DataType.String, 16, '???', "開発技能の訓練"),
    ...
    0x001BFDE4: Data(DataType.String, 20, '???', "自己嫌悪で落ち込む"),
    ...
    0x001BFE48: Data(DataType.String, 24, '???', "ネルフ戦力の現状を見る"),
    ...
    0x001BFEF8: Data(DataType.String, 20, '???', "雰囲気行動起点IM"),
    0x001BFF0C: Data(DataType.String, 16, 'Fidget', "もじもじする"),
    0x001BFF1C: Data(DataType.String, 16, '???', "あくびをする"),
    0x001BFF2C: Data(DataType.String, 16, '???', "お腹がすいた"),
    0x001BFF3C: Data(DataType.String, 12, '???', "頭がかゆい"),
    0x001BFF48: Data(DataType.String, 16, '???', "気合入れてる"),
    0x001BFF58: Data(DataType.String, 16, '???', "ご機嫌な様子"),
    0x001BFF68: Data(DataType.String, 16, '???', "顔がニヤつく"),
    0x001BFF78: Data(DataType.String, 16, '???', "なにやら真剣"),
    0x001BFF88: Data(DataType.String, 16, '???', "拳を握り締め"),
    0x001BFF98: Data(DataType.String, 16, '???', "落胆している"),
    0x001BFFA8: Data(DataType.String, 16, '???', "イライラする"),
    0x001BFFB8: Data(DataType.String, 16, '???', "気が抜けてる"),
    0x001BFFC8: Data(DataType.String, 16, '???', "おどおどする"),
    0x001BFFD8: Data(DataType.String, 16, '???', "額の汗を拭く"),
    0x001BFFE8: Data(DataType.String, 16, 'Gaze at the setting sun', "夕日を眺める"),
    0x001BFFF8: Data(DataType.String, 16, '???', "くしゃみする"),
    0x001C0008: Data(DataType.String, 16, '???', "財布の中を確認"),
    0x001C0018: Data(DataType.String, 16, '???', "商品を手に取る"),
    0x001C0028: Data(DataType.String, 16, '???', "電話をかける"),
    0x001C0038: Data(DataType.String, 16, '???', "携帯電話を操作"),
    0x001C0048: Data(DataType.String, 24, '???', "キャラ固有アクション"),
    0x001C0060: Data(DataType.String, 20, '???', "立ち止まって考え事"),
    ...
    0x001C00A4: Data(DataType.String, 16, '???', "訓練に集中する"),
    0x001C00B4: Data(DataType.String, 24, '???', "訓練の結果に満足する"),
    0x001C00CC: Data(DataType.String, 20, '???', "訓練の結果を叱る"),
    0x001C00E0: Data(DataType.String, 28, '???', "モブIM、会話しているフリ"),
    0x001C00FC: Data(DataType.String, 32, '???', "モブIM、学校トイレに入るフリ"),
    0x001C011C: Data(DataType.String, 24, '???', "モブIM、急いでいるフリ"),
    0x001C0134: Data(DataType.String, 32, '???', "モブIM、ネルフトイレに入るフリ"),
    0x001C0154: Data(DataType.String, 20, '???', "最近の出来事を話す"),
    0x001C0168: Data(DataType.String, 20, '???', "他人の出来事を話す"),
    0x001C017C: Data(DataType.String, 20, '???', "最近の愚痴を話す"),
    0x001C0190: Data(DataType.String, 20, '???', "以前の出来事を話す"),
    0x001C01A4: Data(DataType.String, 24, '???', "公園トイレで用を足す"),
    0x001C01BC: Data(DataType.String, 20, '???', "駅トイレで用を足す"),
    ...
    0x001C02C0: Data(DataType.String, 24, '???', "励ますことを了解する"),
    ...
    0x001C0388: Data(DataType.String, 24, '???', "○○の悪い評判を流す"),
    0x001C03A0: Data(DataType.String, 20, '???', "悪い評判にうなずく"),
    0x001C03B4: Data(DataType.String, 24, '???', "悪い評判に疑問をもつ"),
    0x001C03CC: Data(DataType.String, 20, '???', "悪い評判を否定する"),
    0x001C03E0: Data(DataType.String, 16, '???', "不満をぶつける"),
    0x001C03F0: Data(DataType.String, 20, '???', "黙って聞いている"),
    0x001C0404: Data(DataType.String, 16, '???', "文句を言い返す"),
    0x001C0414: Data(DataType.String, 16, '???', "相手にしない"),
    0x001C0424: Data(DataType.String, 24, '???', "相手をバカにした態度"),
    0x001C043C: Data(DataType.String, 24, '???', "馬鹿にするように笑う"),
    0x001C0454: Data(DataType.String, 20, '???', "ΑΤの低調を叱る"),
    0x001C0468: Data(DataType.String, 16, '???', "力なくあやまる"),
    ...
    0x001C0504: Data(DataType.String, 16, '???', "軽く挨拶を返す"),
    0x001C0514: Data(DataType.String, 16, 'Look at them casually', "何気なく見る"),
    0x001C0524: Data(DataType.String, 20, '???', "気まずい思いをする"),
    0x001C0538: Data(DataType.String, 20, '???', "悪意を込めて見る"),
    0x001C054C: Data(DataType.String, 12, '???', "睨み返す"),
    0x001C0558: Data(DataType.String, 12, '???', "目を逸らす"),
    0x001C0564: Data(DataType.String, 28, '???', "相手の目つきに文句を言う"),
    ...
    0x001C05A0: Data(DataType.String, 12, '???', "うわのそら"),
    ...
    0x001C05E8: Data(DataType.String, 16, '???', "相手を心配する"),
    ...
    0x001C0628: Data(DataType.String, 28, '???', "自滅促進プログラムの作成"),
    0x001C0644: Data(DataType.String, 28, '???', "自滅促進プログラムの実行"),
    0x001C0660: Data(DataType.String, 20, '???', "ユニゾン訓練判定"),
    0x001C0674: Data(DataType.String, 20, '???', "小アラウンド開始"),
    0x001C0688: Data(DataType.String, 20, '???', "フリーターン再開"),
    0x001C069C: Data(DataType.String, 16, '???', "シールをはがす"),
    0x001C06AC: Data(DataType.String, 24, '???', "シールのシートを確認"),
    0x001C06C4: Data(DataType.String, 24, 'Talk to Pen Pen', "ペンペンに話しかける"),
    0x001C06DC: Data(DataType.String, 20, '???', "懸賞の応募を頼む"),
    0x001C06F0: Data(DataType.String, 28, '???', "京都大学出張計画書を作成"),
    ...
    0x001C0748: Data(DataType.String, 16, '???', "ミサトを誘う"),
    ...
    0x001C0780: Data(DataType.String, 20, '???', "トウジに謝りたい"),
    0x001C0794: Data(DataType.String, 20, '???', "トウジの容態を聞く"),
    0x001C07A8: Data(DataType.String, 20, '???', "レイの入院について"),
    0x001C07BC: Data(DataType.String, 24, '???', "アスカの入院について"),
    0x001C07D4: Data(DataType.String, 24, '???', "トウジの入院について"),
    0x001C07EC: Data(DataType.String, 24, 'Regarding Kaworu\'s hospitalization', "カヲルの入院について"),
    0x001C0804: Data(DataType.String, 24, '???', "エヴァの修理効率上昇"),
    ...
    0x001C0988: Data(DataType.String, 16, '???', "やっぱりやめる"),
    0x001C0998: Data(DataType.String, 20, '???', "面会許可をもらう"),
    ...
    0x001C09D8: Data(DataType.String, 20, '???', "12文字ﾀｲﾄﾙ使用不可"),
    ...
    0x001C0A30: Data(DataType.String, 8, '???', "マヤ"),
    0x001C0A38: Data(DataType.String, 8, '???', "日向"),
    0x001C0A40: Data(DataType.String, 8, '???', "青葉"),
    0x001C0A48: Data(DataType.String, 8, '???', "加持"),
    0x001C0A50: Data(DataType.String, 8, '???', "ヒカリ"),
    0x001C0A58: Data(DataType.String, 8, '???', "トウジ"),
    0x001C0A60: Data(DataType.String, 12, '???', "ケンスケ"),
    0x001C0A6C: Data(DataType.String, 8, '???', "カヲル"),
    0x001C0A74: Data(DataType.String, 12, '???', "ペンペン"),
    ...
    0x001C3BA0: Data(DataType.String, 12, '???', "無効ＩＤ"),
    ...
    0x001C3BE4: Data(DataType.String, 12, '???', "落ち込み"),
    0x001C3BF0: Data(DataType.String, 20, '???', "キャラ掘り起こし"),
    0x001C3C04: Data(DataType.String, 12, '???', "盛り上げる"),
    0x001C3C10: Data(DataType.String, 12, 'Psychological Portrait', "心理描写"),
    0x001C3C1C: Data(DataType.String, 12, '???', "強引終らせ"),
    0x001C3C28: Data(DataType.String, 20, '???', "ＩＭ手動選択　　"),
    0x001C3C3C: Data(DataType.String, 20, 'Repeat conversation', "会話リピート　　"),
    0x001C3C50: Data(DataType.String, 20, 'Autoplay', "オートプレイ　　"),
    0x001C3C64: Data(DataType.String, 20, '???', "自動会話進行　　"),
    0x001C3C78: Data(DataType.String, 20, '???', "特殊ＩＭ追加　　"),
    ...
    0x001C3FBC: Data(DataType.String, 24, '???', "充足度が回復しました。"),
    0x001C3FD4: Data(DataType.String, 32, '???', "始末書を１０枚追加しました。"),
    0x001C3FF4: Data(DataType.String, 20, '???', "%sを取得しました。"),
    0x001C4008: Data(DataType.String, 24, '???', "持ち物がいっぱいです。"),
    0x001C4020: Data(DataType.String, 24, '???', "%s%-8s：%s　%s%-8s：%s"),
    ...
    0x001C41D8: Data(DataType.String, 28, '???', "抱き付き放題になりました。"),
    0x001C41F4: Data(DataType.String, 16, '???', "誰に対する？"),
    0x001C4204: Data(DataType.String, 24, '???', "誰の心に入りますか？"),
    ...
    0x001C4E18: Data(DataType.String, 28, '???', "とりあえず終端につきました"),
    ...
    0x001C593C: Data(DataType.String, 12, '???', "出かけない"),
    0x001C5948: Data(DataType.String, 16, '???', "外に出かける"),
    0x001C5958: Data(DataType.String, 12, '???', "校舎に入る"),
    0x001C5964: Data(DataType.String, 12, 'Don\'t go in', "入らない"),
    0x001C5970: Data(DataType.String, 12, '???', "屋上に出る"),
    0x001C5AEC: Data(DataType.String, 24, '???', "すれ違いによる移動中断\n"),
    0x001C5B04: Data(DataType.String, 40, '???', "ずっと同じ場所をループしているような\n"),
    0x001C5E7C: Data(DataType.String, 20, '???', "座標ガイド　　ＯＮ"),
    0x001C5E90: Data(DataType.String, 24, '???', "座標ガイド　　ＯＦＦ"),
    0x001C5EA8: Data(DataType.String, 20, '???', "常駐アイコン　ＯＮ"),
    0x001C5EBC: Data(DataType.String, 24, '???', "常駐アイコン　ＯＦＦ"),
    0x001C5ED4: Data(DataType.String, 20, '???', "キャラの透過　ＯＮ"),
    0x001C5EE8: Data(DataType.String, 24, '???', "キャラの透過　ＯＦＦ"),
    0x001C5F00: Data(DataType.String, 20, '???', "自動壁消し　　ＯＮ"),
    0x001C5F14: Data(DataType.String, 24, '???', "自動壁消し　　ＯＦＦ"),
    0x001C5F2C: Data(DataType.String, 20, 'Snapshot', "スナップショット"),
    0x001C6BDC: Data(DataType.String, 12, '???', "範囲の設定"),
    0x001C6BE8: Data(DataType.String, 16, 'Camera Settings', "カメラの設定"),
    0x001C6BF8: Data(DataType.String, 16, 'Free Camera', "フリーカメラ"),
    0x001C6C08: Data(DataType.String, 28, '???', "（壊れているデータです）"),
    0x001C6C80: Data(DataType.String, 20, '???', "専用カメラを使う"),
    0x001C6C94: Data(DataType.String, 24, '???', "専用カメラを使わない"),
    0x001C6D60: Data(DataType.String, 32, '???', "%sは、ショックから立ち直った。"),
    0x001C6D90: Data(DataType.String, 32, '???', "%sの浮かれた気持ちは治まった。"),
    ...
    0x001C70F8: Data(DataType.String, 28, '???', "来客の対応に向かっている"),
    ...
    0x001C74B4: Data(DataType.String, 4, '???', "万"),
    ...
    0x001C76C4: Data(DataType.String, 32, '???', "なんだか大切なものと感じた。"),
    ...
    0x001C79E8: Data(DataType.String, 28, '???', " しばらく、自宅で過ごした　"),
    0x001C7A04: Data(DataType.String, 28, '???', " しばらく、自室で過ごした　"),
    0x001C7A20: Data(DataType.String, 32, '???', " しばらく、どこかで過ごした　"),
    0x001C7A64: Data(DataType.String, 32, '???', "ＥＶＡ%sの稼動状況　…　ロスト\n"),
    0x001C7A84: Data(DataType.String, 8, '???', "中規模"),
    0x001C7A8C: Data(DataType.String, 8, '???', "軽微"),
    0x001C7A94: Data(DataType.String, 8, '???', "甚大"),
    0x001C7A9C: Data(DataType.String, 8, '???', "壊滅的"),
    0x001C7AA4: Data(DataType.String, 8, '???', "未定義"),
    ...
    0x001C811C: Data(DataType.String, 16, '???', "主要人物の選択"),
    0x001C812C: Data(DataType.String, 16, '???', "対象人物の選択"),
    ...
    0x001C819C: Data(DataType.String, 12, '???', "普通の関係"),
    0x001C81A8: Data(DataType.String, 12, '???', "気になる"),
    0x001C81B4: Data(DataType.String, 12, '???', "気にかかる"),
    0x001C81C0: Data(DataType.String, 12, '???', "たまに会話"),
    0x001C81CC: Data(DataType.String, 16, '???', "馴染みがある"),
    0x001C81DC: Data(DataType.String, 8, '???', "仁慈"),
    0x001C81E4: Data(DataType.String, 8, '???', "思慕"),
    0x001C81EC: Data(DataType.String, 8, '???', "ウザい"),
    0x001C81F4: Data(DataType.String, 8, '???', "嫌悪"),
    0x001C81FC: Data(DataType.String, 8, '???', "忌避"),
    0x001C8204: Data(DataType.String, 12, '???', "いとおしい"),
    0x001C8210: Data(DataType.String, 8, '???', "熱愛"),
    0x001C8218: Data(DataType.String, 8, '???', "友人"),
    0x001C8220: Data(DataType.String, 8, '???', "親友"),
    0x001C8228: Data(DataType.String, 8, '???', "心友"),
    0x001C8230: Data(DataType.String, 8, '???', "友達"),
    0x001C8238: Data(DataType.String, 8, '???', "恋しい"),
    0x001C8240: Data(DataType.String, 8, '???', "愛しい"),
    ...
    0x001C8784: Data(DataType.String, 20, '???', "やっぱり買わない"),
    ...
    0x001C87F4: Data(DataType.String, 24, '???', "%sが抱きついてきた。"),
    ...
    0x001C8848: Data(DataType.String, 24, '???', "%sが側に近づいてきた。"),
    0x001C8860: Data(DataType.String, 20, '???', "挨拶と再開のクリア"),
    0x001C8874: Data(DataType.String, 16, '???', "挨拶のみ設定"),
    0x001C8884: Data(DataType.String, 20, '???', "挨拶と再開の設定"),
    0x001C8898: Data(DataType.String, 8, 'Normal', "通常"),
    0x001C88A0: Data(DataType.String, 8, '???', "破壊"),
    0x001C88A8: Data(DataType.String, 8, '???', "中破壊"),
    0x001C88B0: Data(DataType.String, 8, '???', "大破壊"),
    0x001C88B8: Data(DataType.String, 12, '???', "家事技能"),
    ...
    0x001C8920: Data(DataType.String, 16, '???', "ＡＴ除数変更"),
    0x001C8930: Data(DataType.String, 12, '???', "はげまして"),
    0x001C893C: Data(DataType.String, 16, '???', "好きだと伝えて"),
    0x001C894C: Data(DataType.String, 20, '???', "気になると伝えて"),
    0x001C8960: Data(DataType.String, 20, '???', "興味がないと伝えて"),
    0x001C8974: Data(DataType.String, 20, '???', "目障りだと伝えて"),
    0x001C8988: Data(DataType.String, 16, '???', "嫌いと伝えて"),
    0x001C8998: Data(DataType.String, 12, '???', "気をつけて"),
    0x001C89DC: Data(DataType.String, 8, '???', "どんな"),
    ...
    0x001C8B1C: Data(DataType.String, 12, '???', "初回挨拶"),
    0x001C8B28: Data(DataType.String, 8, '???', "伝言"),
    0x001C8B30: Data(DataType.String, 12, '???', "挨拶と再開"),
    0x001C8B3C: Data(DataType.String, 16, 'Labyrinth of the Heart 35', "心の迷宮３５"),
    0x001C8B4C: Data(DataType.String, 16, '???', "学校準備２２３"),
    0x001C8B5C: Data(DataType.String, 16, '???', "携帯電話２３８"),
    0x001C8B6C: Data(DataType.String, 28, 'Nerv Cafeteria 341-345', "ネルフ食堂３４１−３４５"),
    0x001C8B88: Data(DataType.String, 36, '???', "パイロット辞め家出３５８−３６４"),
    ...
    0x001C8BC8: Data(DataType.String, 16, '???', "トイレ症候群"),
    0x001C8BD8: Data(DataType.String, 8, 'Opinion Brief', "意見書"),
    0x001C8C40: Data(DataType.String, 12, '???', "学園全開"),
    ...
    0x001C8ED8: Data(DataType.String, 12, '???', "学校全開"),
    ...
    0x001C8F24: Data(DataType.String, 24, '???', "初回挨拶済みにしました"),
    ...
    0x001C90A8: Data(DataType.String, 28, '???', "暗殺系の条件を設定します"),
    0x001C90C4: Data(DataType.String, 28, '???', "いろいろダメージを受けます"),
    ...
    0x001C9764: Data(DataType.String, 32, '???', "今は電話が繋がらないようだ。"),
    ...
    0x001C9830: Data(DataType.String, 28, '???', "特殊監査部、加持リョウジ"),
    ...
    0x001C98E8: Data(DataType.String, 20, '???', "中央病院に入院中"),
    0x001C9974: Data(DataType.String, 12, 'Command Center 1', "第１発令所"),
    0x001C9980: Data(DataType.String, 16, '???', "葛城三佐の自宅"),
    0x001C9990: Data(DataType.String, 16, '???', "葛城一尉の自宅"),
    ...
    0x001C9A8C: Data(DataType.String, 24, '???', "ネルフ施設内を移動中"),
    0x001C9AA4: Data(DataType.String, 8, '???', "自宅"),
    ...
    0x001C9B90: Data(DataType.String, 16, '???', "学校への通学路"),
    ...
    0x001CA4A8: Data(DataType.String, 32, '???', "評価できる相手が存在しません。"),
    0x001CA4E4: Data(DataType.String, 28, '???', "%sの、%sに対する人物評価"),
    ...
    0x001CBBD0: Data(DataType.String, 20, '???', "始末書を処理する"),
    0x001CBBE4: Data(DataType.String, 24, '???', "エヴァの補修予算請求"),
    0x001CBBFC: Data(DataType.String, 28, '???', "第３新東京市復興予算請求"),
    ...
    0x001CBD6C: Data(DataType.String, 16, '???', "落ち着かない"),
    0x001CBD7C: Data(DataType.String, 16, '???', "やる気が出ない"),
    0x001CBD8C: Data(DataType.String, 16, '???', "参謀技能訓練"),
    0x001CBD9C: Data(DataType.String, 16, '???', "開発技能訓練"),
    ...
    0x001CBE0C: Data(DataType.String, 16, '???', "訓練に集中する"),
    0x001CBE1C: Data(DataType.String, 28, '???', "自滅促進プログラムの作成"),
    0x001CBE38: Data(DataType.String, 28, '???', "自滅促進プログラムの実行"),
    0x001CBE54: Data(DataType.String, 16, 'Unison Training', "ユニゾン訓練"),
    0x001CBE64: Data(DataType.String, 16, '???', "シールをはがす"),
    0x001CBE74: Data(DataType.String, 28, '???', "京都大学出張計画書を作成"),
    ...
    0x001CC070: Data(DataType.String, 12, '???', "ＡＹＰ性能"),
    0x001CC07C: Data(DataType.String, 12, '???', "相手Ａ.Ｔ."),
    0x001CC088: Data(DataType.String, 8, 'Restroom', "トイレ"),
    0x001CC090: Data(DataType.String, 12, '???', "成績合計"),
    0x001CC09C: Data(DataType.String, 12, '???', "好意合計"),
    0x001CC0A8: Data(DataType.String, 12, '???', "情報合計"),
    0x001CC0B4: Data(DataType.String, 12, '???', "諜報＋事務"),
    0x001CC0C0: Data(DataType.String, 12, '???', "諜報＋情報"),
    0x001CC12C: Data(DataType.String, 20, '???', "に話題を振ったこと"),
    0x001CC140: Data(DataType.String, 16, 'ignoring', "を無視したこと"),
    0x001CC150: Data(DataType.String, 16, 'approaching', "に近づいたこと"),
    0x001CC160: Data(DataType.String, 24, '???', "に、そっけない返事を"),
    0x001CC178: Data(DataType.String, 12, '???', "したこと"),
    0x001CC184: Data(DataType.String, 20, '???', "のふがいない態度を"),
    0x001CC198: Data(DataType.String, 12, '???', "叱ったこと"),
    0x001CC1A4: Data(DataType.String, 12, 'conversation with', "との会話を"),
    0x001CC1B0: Data(DataType.String, 16, '???', "切り上げたこと"),
    0x001CC1C0: Data(DataType.String, 20, '???', "のつれない態度を"),
    0x001CC1D4: Data(DataType.String, 12, '???', "嘆いたこと"),
    0x001CC1E0: Data(DataType.String, 24, '???', "の態度にヘコんだこと"),
    0x001CC1F8: Data(DataType.String, 12, '???', "の態度に"),
    0x001CC204: Data(DataType.String, 20, '???', "動じなかったこと"),
    0x001CC218: Data(DataType.String, 16, '???', "に照れたこと"),
    0x001CC228: Data(DataType.String, 24, '???', "への視線を逸らしたこと"),
    0x001CC240: Data(DataType.String, 20, '???', "に笑いかけたこと"),
    0x001CC254: Data(DataType.String, 16, '???', "に近寄ったこと"),
    0x001CC264: Data(DataType.String, 20, '???', "一人で悩んだこと"),
    0x001CC278: Data(DataType.String, 16, '???', "に機密情報を"),
    0x001CC288: Data(DataType.String, 16, '???', "聞き出したこと"),
    0x001CC298: Data(DataType.String, 16, '???', "からの問いに"),
    0x001CC2A8: Data(DataType.String, 24, '???', "わからないと答えたこと"),
    0x001CC2C0: Data(DataType.String, 16, '???', "に警告したこと"),
    0x001CC2D0: Data(DataType.String, 12, '???', "との話を"),
    0x001CC2DC: Data(DataType.String, 24, '???', "に機密情報を教えたこと"),
    0x001CC2F4: Data(DataType.String, 20, '???', "に怒ってみせたこと"),
    0x001CC308: Data(DataType.String, 20, '???', "から身を離したこと"),
    0x001CC31C: Data(DataType.String, 16, '???', "にキスしたこと"),
    0x001CC32C: Data(DataType.String, 20, '???', "を抱きしめたこと"),
    0x001CC340: Data(DataType.String, 20, '???', "の手を握ったこと"),
    0x001CC354: Data(DataType.String, 20, '???', "にささやいたこと"),
    0x001CC368: Data(DataType.String, 24, '???', "を強く抱きしめたこと"),
    0x001CC380: Data(DataType.String, 24, '???', "と指を絡めあったこと"),
    0x001CC398: Data(DataType.String, 16, '???', "からの誘いを"),
    0x001CC3A8: Data(DataType.String, 16, '???', "拒絶したこと"),
    0x001CC3B8: Data(DataType.String, 20, '???', "に、つれない態度の"),
    0x001CC3CC: Data(DataType.String, 20, '???', "理由を聞いたこと"),
    0x001CC3E0: Data(DataType.String, 20, '???', "に、何でもないと"),
    0x001CC3F4: Data(DataType.String, 12, '???', "照れたこと"),
    0x001CC400: Data(DataType.String, 20, '???', "に、$aへの好意を"),
    0x001CC414: Data(DataType.String, 12, '???', "尋ねたこと"),
    0x001CC420: Data(DataType.String, 24, '???', "に、$aを避ける理由を"),
    0x001CC438: Data(DataType.String, 12, '???', "聞いたこと"),
    0x001CC444: Data(DataType.String, 16, '???', "からの質問に"),
    0x001CC454: Data(DataType.String, 24, '???', "何も答えなかったこと"),
    0x001CC46C: Data(DataType.String, 24, '???', "に、今はダメだと言って"),
    0x001CC484: Data(DataType.String, 24, '???', "に、思わせぶりなことを"),
    0x001CC49C: Data(DataType.String, 12, 'talking', "言ったこと"),
    0x001CC4A8: Data(DataType.String, 24, '???', "に、嫌いだと言ったこと"),
    0x001CC4C0: Data(DataType.String, 24, '???', "に、嬉しいと言ったこと"),
    0x001CC4D8: Data(DataType.String, 20, '???', "に、うそつきだと"),
    0x001CC4EC: Data(DataType.String, 12, '???', "を嫌いだ"),
    0x001CC4F8: Data(DataType.String, 16, 'saying', "と言ったこと"),
    0x001CC508: Data(DataType.String, 20, '???', "に抱きついたこと"),
    0x001CC51C: Data(DataType.String, 20, '???', "から抱きつかれて"),
    0x001CC530: Data(DataType.String, 20, '???', "喜んでみせたこと"),
    0x001CC544: Data(DataType.String, 16, '???', "たしなめたこと"),
    0x001CC554: Data(DataType.String, 20, '???', "から抱きつかれたが"),
    0x001CC568: Data(DataType.String, 16, 'ignoring', "無視したこと"),
    0x001CC578: Data(DataType.String, 12, '???', "に対して、"),
    0x001CC584: Data(DataType.String, 20, '???', "上機嫌で話したこと"),
    0x001CC598: Data(DataType.String, 20, '???', "に、なれなれしく"),
    0x001CC5AC: Data(DataType.String, 12, '???', "接したこと"),
    0x001CC5B8: Data(DataType.String, 24, '???', "のなれなれしい態度に"),
    0x001CC5D0: Data(DataType.String, 24, '???', "そっけなく応対したこと"),
    0x001CC5E8: Data(DataType.String, 24, '???', "のなれなれしい態度を"),
    0x001CC600: Data(DataType.String, 24, '???', "冷たくあしらったこと"),
    0x001CC618: Data(DataType.String, 20, '???', "首をかしげたこと"),
    0x001CC62C: Data(DataType.String, 16, '???', "を心配したこと"),
    0x001CC63C: Data(DataType.String, 24, '???', "の様子を観察したこと"),
    0x001CC654: Data(DataType.String, 8, '???', "に、"),
    0x001CC65C: Data(DataType.String, 28, '???', "我に返ってあやまったこと"),
    0x001CC678: Data(DataType.String, 12, '???', "を前にして"),
    0x001CC684: Data(DataType.String, 24, '???', "ぼーっとしていたこと"),
    0x001CC69C: Data(DataType.String, 24, '???', "泣きそうな顔をしたこと"),
    0x001CC6B4: Data(DataType.String, 16, '???', "に、何でもない"),
    0x001CC6C4: Data(DataType.String, 16, '???', "に、暗い調子で"),
    0x001CC6D4: Data(DataType.String, 16, '???', "話しかけたこと"),
    0x001CC6E4: Data(DataType.String, 24, '???', "に、そんな気分じゃない"),
    0x001CC6FC: Data(DataType.String, 16, '???', "腹を立てたこと"),
    0x001CC70C: Data(DataType.String, 12, '???', "の態度で"),
    0x001CC718: Data(DataType.String, 20, '???', "上機嫌になったこと"),
    0x001CC72C: Data(DataType.String, 28, '???', "間をあけてうなずいたこと"),
    0x001CC748: Data(DataType.String, 24, '???', "の泣きそうな顔を見ても"),
    0x001CC760: Data(DataType.String, 20, '???', "知らんぷりしたこと"),
    0x001CC774: Data(DataType.String, 24, '???', "の泣きそうな顔を見て"),
    0x001CC78C: Data(DataType.String, 28, '???', "なぐさめの声をかけたこと"),
    0x001CC7A8: Data(DataType.String, 16, '???', "励ましたこと"),
    0x001CC7B8: Data(DataType.String, 24, '???', "に、何も言わなくていい"),
    0x001CC7D0: Data(DataType.String, 16, '???', "黙っていたこと"),
    0x001CC7E0: Data(DataType.String, 24, '???', "に、やっぱり何でもない"),
    0x001CC7F8: Data(DataType.String, 12, '???', "のことを、"),
    0x001CC804: Data(DataType.String, 24, '???', "変な奴だと思ったこと"),
    0x001CC81C: Data(DataType.String, 16, '???', "に注意したこと"),
    0x001CC82C: Data(DataType.String, 24, '???', "に観察されているとき"),
    0x001CC844: Data(DataType.String, 20, 'sighing', "ため息をついたこと"),
    0x001CC858: Data(DataType.String, 20, '???', "を突き放したこと"),
    0x001CC86C: Data(DataType.String, 16, '???', "に、気にするな"),
    0x001CC87C: Data(DataType.String, 24, '???', "の返事に了解したこと"),
    0x001CC894: Data(DataType.String, 20, '???', "の肩を叩いたこと"),
    0x001CC8A8: Data(DataType.String, 24, '???', "に、何かと尋ねたこと"),
    0x001CC8C0: Data(DataType.String, 16, '???', "に、こんな話は"),
    0x001CC8D0: Data(DataType.String, 28, '???', "退屈そうだね、と言ったこと"),
    0x001CC8EC: Data(DataType.String, 8, '???', "から、"),
    0x001CC8F4: Data(DataType.String, 24, '???', "それとなく離れたこと"),
    0x001CC90C: Data(DataType.String, 16, 'taking a bath', "入浴したこと"),
    0x001CC91C: Data(DataType.String, 12, '???', "の勉強を"),
    0x001CC928: Data(DataType.String, 16, '???', "邪魔したこと"),
    0x001CC938: Data(DataType.String, 28, '???', "に勉強の邪魔をされたので"),
    0x001CC954: Data(DataType.String, 20, '???', "文句を言ったこと"),
    0x001CC968: Data(DataType.String, 24, '???', "に勉強の邪魔をされたが"),
    0x001CC980: Data(DataType.String, 24, 'ignoring and studying', "無視して勉強したこと"),
    0x001CC998: Data(DataType.String, 20, '???', "椅子に座ったこと"),
    0x001CC9AC: Data(DataType.String, 24, '???', "に文句を言われたので、"),
    0x001CC9C4: Data(DataType.String, 20, '???', "の相手をしたこと"),
    0x001CC9D8: Data(DataType.String, 20, '???', "の相手は出来ない"),
    0x001CC9EC: Data(DataType.String, 16, '???', "と拒んだこと"),
    0x001CC9FC: Data(DataType.String, 16, '???', "にかまうのを"),
    0x001CCA0C: Data(DataType.String, 16, '???', "あきらめたこと"),
    0x001CCA1C: Data(DataType.String, 20, '???', "を釣りに誘ったこと"),
    0x001CCA30: Data(DataType.String, 16, '???', "（記憶会話）"),
    0x001CCA40: Data(DataType.String, 12, 'together with', "と一緒に"),
    0x001CCA4C: Data(DataType.String, 20, 'watching T.V.', "テレビを観たこと"),
    0x001CCA60: Data(DataType.String, 28, '???', "とテレビを観ているときに"),
    0x001CCA7C: Data(DataType.String, 24, 'changing the channel', "チャンネルを変えたこと"),
    0x001CCA94: Data(DataType.String, 24, '???', "番組の文句を言ったこと"),
    0x001CCAAC: Data(DataType.String, 20, '???', "のチャンネル変更に"),
    0x001CCAC0: Data(DataType.String, 12, '???', "にかまわず"),
    0x001CCACC: Data(DataType.String, 24, '???', "黙ってテレビを観たこと"),
    0x001CCAE4: Data(DataType.String, 24, '???', "の話に興味を持ったこと"),
    0x001CCAFC: Data(DataType.String, 20, '???', "と雑談をしたこと"),
    0x001CCB10: Data(DataType.String, 12, '???', "（削除）"),
    0x001CCB1C: Data(DataType.String, 20, '???', "に、学校の成績を"),
    0x001CCB30: Data(DataType.String, 20, '???', "に、学校の成績は"),
    0x001CCB44: Data(DataType.String, 28, '???', "かなり良い、と答えたこと"),
    0x001CCB60: Data(DataType.String, 28, '???', "まあまあだ、と答えたこと"),
    0x001CCB7C: Data(DataType.String, 24, '???', "に、学校の成績は悪い"),
    0x001CCB94: Data(DataType.String, 16, '???', "と答えたこと"),
    0x001CCBA4: Data(DataType.String, 24, '???', "に、学校の成績は最悪だ"),
    0x001CCBBC: Data(DataType.String, 12, '???', "に対して"),
    0x001CCBC8: Data(DataType.String, 20, '???', "ふてくされたこと"),
    0x001CCBDC: Data(DataType.String, 24, '???', "の寝言に苦笑いしたこと"),
    0x001CCBF4: Data(DataType.String, 16, '???', "を、とりあえず"),
    0x001CCC04: Data(DataType.String, 16, '???', "抱きしめたこと"),
    0x001CCC14: Data(DataType.String, 16, '???', "に、とりあえず"),
    0x001CCC24: Data(DataType.String, 16, '???', "抱き返したこと"),
    0x001CCC34: Data(DataType.String, 20, '???', "から、とりあえず"),
    0x001CCC48: Data(DataType.String, 12, '???', "離れたこと"),
    0x001CCC54: Data(DataType.String, 24, '???', "と、自滅促進プログラム"),
    0x001CCC6C: Data(DataType.String, 24, '???', "について、話をしたこと"),
    0x001CCC84: Data(DataType.String, 28, '???', "からお小遣いを貰ったので"),
    0x001CCCA0: Data(DataType.String, 16, 'thanking', "礼を言ったこと"),
    0x001CCCB0: Data(DataType.String, 24, '???', "に、お小遣いが欲しい"),
    0x001CCCC8: Data(DataType.String, 16, '???', "に、お小遣いを"),
    0x001CCCD8: Data(DataType.String, 12, '???', "渡したこと"),
    0x001CCCE4: Data(DataType.String, 24, '???', "上げられなかったこと"),
    0x001CCCFC: Data(DataType.String, 24, '???', "からお小遣いを貰えず"),
    0x001CCD14: Data(DataType.String, 24, '???', "$bに文句を言ったこと"),
    0x001CCD2C: Data(DataType.String, 20, '???', "と、リツコのΑΤを"),
    0x001CCD40: Data(DataType.String, 16, '???', "心配したこと"),
    0x001CCD50: Data(DataType.String, 24, '???', "に、リツコなら大丈夫"),
    0x001CCD68: Data(DataType.String, 24, '???', "と伝え、安心させたこと"),
    0x001CCD80: Data(DataType.String, 24, '???', "に対して気まずくなり、"),
    0x001CCD98: Data(DataType.String, 20, '???', "黙ってしまったこと"),
    0x001CCDAC: Data(DataType.String, 16, '???', "に、情報収集を"),
    0x001CCDBC: Data(DataType.String, 12, '???', "頼んだこと"),
    0x001CCDC8: Data(DataType.String, 24, '???', "からの情報収集依頼に"),
    0x001CCDE0: Data(DataType.String, 16, '???', "了解したこと"),
    0x001CCDF0: Data(DataType.String, 20, '???', "の情報収集協力に"),
    0x001CCE04: Data(DataType.String, 24, '???', "からの情報収集依頼を"),
    0x001CCE1C: Data(DataType.String, 12, '???', "断ったこと"),
    0x001CCE28: Data(DataType.String, 20, '???', "に耳打ちしたこと"),
    0x001CCE3C: Data(DataType.String, 24, '???', "に相づちをうったこと"),
    0x001CCE54: Data(DataType.String, 16, '???', "に、心配するな"),
    0x001CCE64: Data(DataType.String, 20, '???', "との作戦会議で、"),
    0x001CCE78: Data(DataType.String, 28, '???', "質問の有無を確認したこと"),
    0x001CCE94: Data(DataType.String, 24, '???', "の提示した作戦内容に"),
    0x001CCEAC: Data(DataType.String, 24, '???', "対して、意見したこと"),
    0x001CCEC4: Data(DataType.String, 16, '???', "の作戦内容に"),
    0x001CCED4: Data(DataType.String, 12, '???', "従ったこと"),
    0x001CCEE0: Data(DataType.String, 28, '???', "の作戦内容に対する不満に"),
    0x001CCEFC: Data(DataType.String, 16, '???', "異論したこと"),
    0x001CCF0C: Data(DataType.String, 16, '???', "との作戦会議で"),
    0x001CCF1C: Data(DataType.String, 32, '???', "作戦を決定し、使徒に挑んだこと"),
    0x001CCF3C: Data(DataType.String, 16, '???', "の異論に対して"),
    0x001CCF4C: Data(DataType.String, 16, '???', "言い返したこと"),
    0x001CCF5C: Data(DataType.String, 20, '???', "しぶしぶ従ったこと"),
    0x001CCF70: Data(DataType.String, 20, '???', "に、食事の相席を"),
    0x001CCF84: Data(DataType.String, 12, '???', "求めたこと"),
    0x001CCF90: Data(DataType.String, 24, '???', "求められ、了承したこと"),
    0x001CCFA8: Data(DataType.String, 16, '???', "の横に座って"),
    0x001CCFB8: Data(DataType.String, 16, '???', "食事をしたこと"),
    0x001CCFC8: Data(DataType.String, 28, '???', "求められたが、断ったこと"),
    0x001CCFE4: Data(DataType.String, 24, '???', "断られて、ヘコんだこと"),
    0x001CCFFC: Data(DataType.String, 28, '???', "に、エヴァのパイロットを"),
    0x001CD018: Data(DataType.String, 24, '???', "辞める、と言ったこと"),
    0x001CD030: Data(DataType.String, 24, '???', "に、パイロットを辞める"),
    0x001CD048: Data(DataType.String, 28, '???', "と言われ、受け入れたこと"),
    0x001CD064: Data(DataType.String, 24, '???', "決意を問いただしたこと"),
    0x001CD07C: Data(DataType.String, 32, '???', "決意は変わらないと言ったこと"),
    0x001CD09C: Data(DataType.String, 24, '???', "に、パイロット辞任は"),
    0x001CD0B4: Data(DataType.String, 20, '???', "ウソだと言ったこと"),
    0x001CD0C8: Data(DataType.String, 28, '???', "ウソだと言われ、怒ったこと"),
    0x001CD0E4: Data(DataType.String, 16, '???', "に愚痴ったこと"),
    0x001CD0F4: Data(DataType.String, 12, '???', "の愚痴を"),
    0x001CD100: Data(DataType.String, 20, '???', "黙って聞いたこと"),
    0x001CD114: Data(DataType.String, 24, '???', "の愚痴に同意したこと"),
    0x001CD12C: Data(DataType.String, 16, '???', "の愚痴に対して"),
    0x001CD13C: Data(DataType.String, 20, '???', "疑問に思ったこと"),
    0x001CD150: Data(DataType.String, 24, '???', "に、愚痴り続けたこと"),
    0x001CD168: Data(DataType.String, 24, '???', "の黙り込んだ様子に触れ"),
    0x001CD180: Data(DataType.String, 16, '???', "$aも黙ったこと"),
    0x001CD190: Data(DataType.String, 20, '???', "の愚痴る様子に呆れ"),
    0x001CD1A4: Data(DataType.String, 16, '???', "突き放したこと"),
    0x001CD1B4: Data(DataType.String, 16, '???', "の続く愚痴を"),
    0x001CD1C4: Data(DataType.String, 20, '???', "に真実を知りたいか"),
    0x001CD1D8: Data(DataType.String, 32, '???', "と聞かれ、はい、と答えたこと"),
    0x001CD1F8: Data(DataType.String, 32, '???', "と聞かれ、いいえ、と答えたこと"),
    0x001CD218: Data(DataType.String, 28, '???', "に本当に真実を知りたいか"),
    0x001CD234: Data(DataType.String, 20, '???', "と、更に尋ねたこと"),
    0x001CD248: Data(DataType.String, 20, '???', "に、やっぱり真実は"),
    0x001CD25C: Data(DataType.String, 32, '???', "知らなくていい、と答えたこと"),
    0x001CD27C: Data(DataType.String, 16, '???', "に、どうしても"),
    0x001CD28C: Data(DataType.String, 32, '???', "真実を知りたい、と答えたこと"),
    0x001CD2AC: Data(DataType.String, 28, '???', "に、セントラルドグマへの"),
    0x001CD2C8: Data(DataType.String, 24, '???', "潜入方法を教えたこと"),
    0x001CD2E0: Data(DataType.String, 16, 'an opinion brief from', "からの意見書を"),
    0x001CD2F0: Data(DataType.String, 16, '???', "受け取ったこと"),
    0x001CD300: Data(DataType.String, 12, 'opinion brief', "の意見書を"),
    0x001CD30C: Data(DataType.String, 16, '???', "破り捨てたこと"),
    0x001CD31C: Data(DataType.String, 16, '???', "拒否したこと"),
    0x001CD32C: Data(DataType.String, 24, 'giving an opinion brief to', "に、意見書を渡したこと"),
    0x001CD344: Data(DataType.String, 16, '???', "に意見書受理を"),
    0x001CD354: Data(DataType.String, 28, '???', "拒否され、食い下がったこと"),
    0x001CD370: Data(DataType.String, 24, '???', "仕方なく受理したこと"),
    0x001CD388: Data(DataType.String, 16, '???', "強く拒んだこと"),
    0x001CD398: Data(DataType.String, 16, '???', "に謝ったこと"),
    0x001CD3A8: Data(DataType.String, 20, '???', "に逆ギレしたこと"),
    0x001CD3BC: Data(DataType.String, 12, '???', "に叱られ"),
    0x001CD3C8: Data(DataType.String, 24, 'examining an opinion brief', "意見書を審査したこと"),
    0x001CD3E0: Data(DataType.String, 16, '???', "をウザく感じて"),
    0x001CD3F0: Data(DataType.String, 16, 'being ignored by', "に無視されて"),
    0x001CD400: Data(DataType.String, 16, '???', "ヘコんだこと"),
    0x001CD410: Data(DataType.String, 20, '???', "に、仕事中なのか"),
    0x001CD424: Data(DataType.String, 16, '???', "に、仕事中だと"),
    0x001CD434: Data(DataType.String, 12, '???', "答えたこと"),
    0x001CD440: Data(DataType.String, 20, '???', "に、仕事中だから"),
    0x001CD454: Data(DataType.String, 24, '???', "邪魔だ、と言ったこと"),
    0x001CD46C: Data(DataType.String, 24, '???', "に、一緒に勉強しよう"),
    0x001CD484: Data(DataType.String, 20, '???', "と持ちかけたこと"),
    0x001CD498: Data(DataType.String, 24, '???', "と一緒に勉強したこと"),
    0x001CD4B0: Data(DataType.String, 20, '???', "からの勉強の誘いを"),
    0x001CD4C4: Data(DataType.String, 24, '???', "に、授業の復習をしよう"),
    0x001CD4DC: Data(DataType.String, 12, 'together,', "と一緒に、"),
    0x001CD4E8: Data(DataType.String, 24, 'reviewing class work', "授業の復習をしたこと"),
    0x001CD500: Data(DataType.String, 28, '???', "からの授業の復習の誘いを"),
    0x001CD51C: Data(DataType.String, 24, '???', "に、一緒に戦闘訓練を"),
    0x001CD534: Data(DataType.String, 28, '???', "しよう、と持ちかけたこと"),
    ...
    0x001CD57C: Data(DataType.String, 20, '???', "に、調査の協力を"),
    0x001CD590: Data(DataType.String, 16, '???', "お願いしたこと"),
    0x001CD5A0: Data(DataType.String, 24, '???', "からの調査協力の依頼を"),
    0x001CD5B8: Data(DataType.String, 16, '???', "承諾したこと"),
    0x001CD5C8: Data(DataType.String, 16, '???', "をおだてたこと"),
    0x001CD5D8: Data(DataType.String, 16, '???', "におだてられて"),
    0x001CD5E8: Data(DataType.String, 24, '???', "良い気分になったこと"),
    0x001CD600: Data(DataType.String, 20, '???', "におだてられたが、"),
    0x001CD614: Data(DataType.String, 24, '???', "いぶかしく感じたこと"),
    0x001CD62C: Data(DataType.String, 12, '???', "の寝姿を"),
    0x001CD638: Data(DataType.String, 16, '???', "覗き込んだこと"),
    0x001CD648: Data(DataType.String, 28, '???', "異論が出たが、強行したこと"),
    0x001CD664: Data(DataType.String, 32, 'going to the convenience store\'s bathroom', "コンビニのトイレに行ったこと"),
    0x001CD684: Data(DataType.String, 12, '???', "の相手を"),
    0x001CD690: Data(DataType.String, 20, '???', "テキトーにしたこと"),
    0x001CD6A4: Data(DataType.String, 24, '???', "壁に八つ当たりしたこと"),
    0x001CD6BC: Data(DataType.String, 24, '???', "の食事にあやかったこと"),
    ...
    0x001CD718: Data(DataType.String, 16, '???', "家出したこと"),
    0x001CD728: Data(DataType.String, 28, 'being mindful of others\' circumstances', "他人の様子を心に留めたこと"),
    0x001CD744: Data(DataType.String, 24, '???', "にアイテムを見せたこと"),
    0x001CD75C: Data(DataType.String, 24, '???', "にアイテムを見せられて"),
    0x001CD774: Data(DataType.String, 16, '???', "困惑したこと"),
    0x001CD784: Data(DataType.String, 20, '???', "に見せたアイテムを"),
    0x001CD798: Data(DataType.String, 28, '???', "プレゼントすると言ったこと"),
    0x001CD7B4: Data(DataType.String, 20, 'an item shown to', "に見せたアイテムは"),
    0x001CD7C8: Data(DataType.String, 28, '???', "見せただけだと言ったこと"),
    ...
    0x001CD828: Data(DataType.String, 28, '???', "にプレゼントを渡したくて"),
    0x001CD844: Data(DataType.String, 20, '???', "食い下がったこと"),
    0x001CD858: Data(DataType.String, 24, '???', "しぶしぶ受け取ったこと"),
    0x001CD870: Data(DataType.String, 28, '???', "へのプレゼントを断られて"),
    0x001CD88C: Data(DataType.String, 28, '???', "に、アイテムを見せただけ"),
    0x001CD8A8: Data(DataType.String, 32, '???', "と言われたが、平然としたこと"),
    0x001CD8C8: Data(DataType.String, 24, 'that it\'s really a present', "に、本当はプレゼントだ"),
    0x001CD8E0: Data(DataType.String, 20, '???', "の平然とした態度に"),
    0x001CD8F4: Data(DataType.String, 20, '???', "拍子抜けしたこと"),
    0x001CD908: Data(DataType.String, 28, '???', "呆れながら受け取ったこと"),
    0x001CD924: Data(DataType.String, 20, '???', "に、何しに来たのか"),
    0x001CD938: Data(DataType.String, 20, '???', "は入院中だったが、"),
    0x001CD94C: Data(DataType.String, 20, '???', "出撃要請をしたこと"),
    0x001CD960: Data(DataType.String, 24, '???', "は入院中だったので、"),
    0x001CD978: Data(DataType.String, 24, '???', "呼び出さなかったこと"),
    0x001CD990: Data(DataType.String, 24, '???', "に、出撃させてほしい"),
    0x001CD9A8: Data(DataType.String, 16, '???', "と頼んだこと"),
    0x001CD9B8: Data(DataType.String, 20, '???', "に、役にたつから"),
    0x001CD9CC: Data(DataType.String, 28, '???', "出撃させろ、と言ったこと"),
    0x001CD9E8: Data(DataType.String, 28, '???', "に、援護くらいなら出来る"),
    0x001CDA04: Data(DataType.String, 24, '???', "の出撃を許可したこと"),
    0x001CDA1C: Data(DataType.String, 20, '???', "からの出撃要請に"),
    0x001CDA30: Data(DataType.String, 20, '???', "からの出撃要請を"),
    0x001CDA44: Data(DataType.String, 12, '???', "拒んだこと"),
    0x001CDA50: Data(DataType.String, 24, '???', "に、退院を報告したこと"),
    0x001CDA68: Data(DataType.String, 24, '???', "からの退院報告を受けて"),
    0x001CDA80: Data(DataType.String, 20, 'worrying about $b', "$bを気遣ったこと"),
    0x001CDA94: Data(DataType.String, 16, '???', "に、今の状況を"),
    0x001CDAA4: Data(DataType.String, 24, '???', "の気遣いに、大丈夫だと"),
    0x001CDABC: Data(DataType.String, 20, '???', "に、$aが居なくて"),
    0x001CDAD0: Data(DataType.String, 24, '???', "大変だったか尋ねたこと"),
    0x001CDAE8: Data(DataType.String, 16, '???', "に、今の状況は"),
    0x001CDAF8: Data(DataType.String, 32, '???', "あまり良くない、と答えたこと"),
    0x001CDB18: Data(DataType.String, 20, '???', "に、今の状況なんて"),
    0x001CDB2C: Data(DataType.String, 28, '???', "気にするな、と言ったこと"),
    0x001CDB48: Data(DataType.String, 20, '???', "に、微笑んだこと"),
    0x001CDB5C: Data(DataType.String, 16, '???', "に、気をつけて"),
    0x001CDB6C: Data(DataType.String, 28, '???', "に、別に大変じゃなかった"),
    0x001CDB88: Data(DataType.String, 24, '???', "に、それなりに辛かった"),
    0x001CDBA0: Data(DataType.String, 20, '???', "の言葉に驚いたこと"),
    0x001CDBB4: Data(DataType.String, 24, '???', "の言葉に愕然としたこと"),
    0x001CDBCC: Data(DataType.String, 16, '???', "と現状について"),
    0x001CDBDC: Data(DataType.String, 12, 'talking', "話したこと"),
    0x001CDBE8: Data(DataType.String, 28, '???', "からの現状についての話に"),
    0x001CDC04: Data(DataType.String, 24, '???', "黙ってうなずいたこと"),
    0x001CDC1C: Data(DataType.String, 24, '???', "の現状についての話に、"),
    0x001CDC34: Data(DataType.String, 24, '???', "心配は無いと答えたこと"),
    0x001CDC4C: Data(DataType.String, 28, '???', "からの現状についての話で"),
    0x001CDC68: Data(DataType.String, 20, '???', "気まずくなったこと"),
    0x001CDC7C: Data(DataType.String, 12, '???', "との会話で"),
    0x001CDC88: Data(DataType.String, 20, '???', "相づちをうったこと"),
    0x001CDC9C: Data(DataType.String, 20, '???', "に、何を食べるのか"),
    0x001CDCB0: Data(DataType.String, 24, '???', "に、食べるメニューを"),
    0x001CDCC8: Data(DataType.String, 12, 'telling', "伝えたこと"),
    0x001CDCD4: Data(DataType.String, 28, '???', "に何を食べるか聞かれたが"),
    0x001CDCF0: Data(DataType.String, 24, '???', "に何を食べるか聞かれて"),
    0x001CDD08: Data(DataType.String, 28, '???', "迷っている、と答えたこと"),
    0x001CDD24: Data(DataType.String, 20, '???', "の決めたメニューは"),
    0x001CDD38: Data(DataType.String, 24, '???', "美味しいのか尋ねたこと"),
    0x001CDD50: Data(DataType.String, 24, '???', "に、伝えたメニューは"),
    0x001CDD68: Data(DataType.String, 32, '???', "なかなか美味しい、と答えたこと"),
    0x001CDD88: Data(DataType.String, 32, '???', "オススメはしない、と答えたこと"),
    0x001CDDA8: Data(DataType.String, 24, 'casually greeting', "に、軽く挨拶したこと"),
    0x001CDDC0: Data(DataType.String, 16, '???', "からの挨拶に"),
    0x001CDDD0: Data(DataType.String, 16, '???', "返事をしたこと"),
    0x001CDDE0: Data(DataType.String, 24, '???', "に、小遣いを渡したこと"),
    0x001CDDF8: Data(DataType.String, 28, '???', "コンビニで商品を選んだこと"),
    0x001CDE14: Data(DataType.String, 28, '???', "コンビニで買い物をしたこと"),
    0x001CDE30: Data(DataType.String, 28, '???', "自宅で残務処理をしたこと"),
    0x001CDE4C: Data(DataType.String, 24, '???', "始末書の処理をしたこと"),
    0x001CDE64: Data(DataType.String, 24, 'the Eva maintenance budget', "エヴァの補修予算請求を"),
    0x001CDE7C: Data(DataType.String, 28, '???', "支援施設の修復予算請求を"),
    ...
    0x001CDF00: Data(DataType.String, 28, '???', "ΑΤフィールド増幅試験を"),
    0x001CDF1C: Data(DataType.String, 20, '???', "オペレーター業務を"),
    0x001CDF30: Data(DataType.String, 24, '???', "司令業務を行ったこと"),
    0x001CDF48: Data(DataType.String, 24, 'carrying out deputy commander duties', "副司令業務を行ったこと"),
    0x001CDF60: Data(DataType.String, 20, '???', "にかまってみたこと"),
    0x001CDF74: Data(DataType.String, 16, '???', "にかまわれて"),
    0x001CDF84: Data(DataType.String, 20, '???', "不思議に思ったこと"),
    0x001CDF98: Data(DataType.String, 24, 'ignoring and disengaging', "を無視して離れたこと"),
    0x001CDFB0: Data(DataType.String, 20, '???', "の頭をなでたこと"),
    0x001CDFC4: Data(DataType.String, 20, '???', "に皮肉を言ったこと"),
    0x001CDFD8: Data(DataType.String, 16, '???', "に離れられて、"),
    0x001CDFE8: Data(DataType.String, 24, '???', "ちょっと寂しかったこと"),
    0x001CE000: Data(DataType.String, 8, 'about', "の事は"),
    0x001CE008: Data(DataType.String, 20, '???', "放っておいたこと"),
    0x001CE01C: Data(DataType.String, 20, '???', "に、すり寄ったこと"),
    0x001CE030: Data(DataType.String, 24, '???', "に、すり寄られたので"),
    0x001CE048: Data(DataType.String, 24, '???', "どうしたと尋ねたこと"),
    0x001CE060: Data(DataType.String, 20, '???', "に何かを伝えるべく"),
    0x001CE074: Data(DataType.String, 20, '???', "グエと鳴いたこと"),
    0x001CE088: Data(DataType.String, 12, 'toward', "に向かって"),
    0x001CE094: Data(DataType.String, 28, '???', "かわいいしぐさをしたこと"),
    0x001CE0B0: Data(DataType.String, 16, '???', "に、かわいい"),
    0x001CE0C0: Data(DataType.String, 24, '???', "に、何かを言われたが"),
    0x001CE0D8: Data(DataType.String, 20, '???', "わからなかったこと"),
    0x001CE0EC: Data(DataType.String, 24, '???', "に、資料を渡したこと"),
    0x001CE104: Data(DataType.String, 20, '???', "から資料を受け取り"),
    0x001CE118: Data(DataType.String, 20, '???', "に、入手した情報を"),
    0x001CE12C: Data(DataType.String, 16, '???', "耳打ちしたこと"),
    0x001CE13C: Data(DataType.String, 24, '???', "から情報を伝えてもらい"),
    0x001CE154: Data(DataType.String, 16, '???', "に、何か話して"),
    0x001CE164: Data(DataType.String, 16, '???', "とせがんだこと"),
    0x001CE174: Data(DataType.String, 20, '???', "気分転換をしたこと"),
    0x001CE188: Data(DataType.String, 16, '???', "になでられて"),
    0x001CE198: Data(DataType.String, 20, '???', "気持ち良かったこと"),
    ...
    0x001CE1E0: Data(DataType.String, 20, '???', "に、仕事の調子を"),
    0x001CE1F4: Data(DataType.String, 24, '???', "に仕事の調子を尋ねられ"),
    0x001CE20C: Data(DataType.String, 20, '???', "順調だと答えたこと"),
    0x001CE220: Data(DataType.String, 24, '???', "芳しくないと答えたこと"),
    0x001CE238: Data(DataType.String, 12, '\'s work', "の作業を"),
    0x001CE244: Data(DataType.String, 16, '???', "ねぎらったこと"),
    0x001CE254: Data(DataType.String, 24, '???', "からのねぎらいの言葉に"),
    0x001CE26C: Data(DataType.String, 16, '???', "返答したこと"),
    0x001CE27C: Data(DataType.String, 20, '???', "謙遜してみせたこと"),
    0x001CE290: Data(DataType.String, 24, '???', "に、仕事の邪魔をした"),
    0x001CE2A8: Data(DataType.String, 16, '???', "と謝ったこと"),
    0x001CE2B8: Data(DataType.String, 20, '???', "の仕事が大変そうだ"),
    0x001CE2CC: Data(DataType.String, 16, '???', "に状況の不安を"),
    0x001CE2DC: Data(DataType.String, 12, '???', "語ったこと"),
    0x001CE2E8: Data(DataType.String, 24, 'a silly story to', "に、たわいもない話を"),
    0x001CE300: Data(DataType.String, 12, '???', "の退院を"),
    0x001CE30C: Data(DataType.String, 16, 'worrying', "気遣ったこと"),
    0x001CE31C: Data(DataType.String, 24, '???', "シャワーを浴びたこと"),
    0x001CE334: Data(DataType.String, 24, 'about the previous battle to', "に、前回の戦闘について"),
    0x001CE34C: Data(DataType.String, 28, '???', "の、前回の戦闘での活躍を"),
    0x001CE368: Data(DataType.String, 16, '???', "賞賛したこと"),
    0x001CE378: Data(DataType.String, 28, '???', "の、前回の戦闘での善戦を"),
    0x001CE394: Data(DataType.String, 16, 'praising', "たたえたこと"),
    0x001CE3A4: Data(DataType.String, 20, '???', "に、今の調子でいけ"),
    0x001CE3B8: Data(DataType.String, 20, '"Be more careful!"', "に、もっと注意しろ"),
    0x001CE3CC: Data(DataType.String, 12, '???', "に、もっと"),
    0x001CE3D8: Data(DataType.String, 32, '???', "気を引き締めろ、と言ったこと"),
    ...
    0x001CE42C: Data(DataType.String, 28, '???', "には、パイロットは無理だ"),
    0x001CE448: Data(DataType.String, 16, 'that it was an easy win', "に、楽勝だった"),
    0x001CE458: Data(DataType.String, 20, '???', "に、労せず勝てた"),
    ...
    0x001CE494: Data(DataType.String, 24, '???', "に、本調子じゃなかった"),
    ...
    0x001CE4F0: Data(DataType.String, 20, '???', "に、弱気な態度を"),
    ...
    0x001CE55C: Data(DataType.String, 32, '???', "迎撃機能は整った、と言ったこと"),
    ...
    0x001CE5B4: Data(DataType.String, 28, '???', "ほぼ疎開した、と言ったこと"),
    0x001CE5D0: Data(DataType.String, 24, '???', "に、第３新東京市の迎撃"),
    0x001CE5E8: Data(DataType.String, 32, '???', "機能は期待薄だ、と言ったこと"),
    0x001CE608: Data(DataType.String, 28, '???', "に、第３新東京市の破棄が"),
    0x001CE624: Data(DataType.String, 24, '???', "決定した、と言ったこと"),
    0x001CE63C: Data(DataType.String, 28, '???', "に、使徒迎撃機能が万全で"),
    0x001CE658: Data(DataType.String, 24, '???', "安心だ、と答えたこと"),
    0x001CE670: Data(DataType.String, 20, '???', "に、都市機能は万全"),
    0x001CE684: Data(DataType.String, 32, '???', "あとはエヴァ次第、と答えたこと"),
    0x001CE6A4: Data(DataType.String, 16, '???', "に、都市機能は"),
    0x001CE6B4: Data(DataType.String, 32, '???', "しばらくは大丈夫、と答えたこと"),
    0x001CE6D4: Data(DataType.String, 28, '???', "に、都市機能に不安があり"),
    0x001CE6F0: Data(DataType.String, 32, '???', "戦いは五分五分だ、と答えたこと"),
    0x001CE710: Data(DataType.String, 24, '???', "に、都市機能不全のため"),
    0x001CE728: Data(DataType.String, 32, '???', "苦戦するだろう、と答えたこと"),
    0x001CE748: Data(DataType.String, 24, '???', "に、住民の疎開が進んで"),
    0x001CE760: Data(DataType.String, 32, '???', "もっと寂しくなる、と答えたこと"),
    0x001CE780: Data(DataType.String, 24, '???', "に、都市の迎撃機能には"),
    0x001CE798: Data(DataType.String, 28, '???', "期待出来ない、と答えたこと"),
    0x001CE7B4: Data(DataType.String, 24, '???', "に、第３新東京市とも"),
    0x001CE7CC: Data(DataType.String, 24, '???', "お別れだ、と答えたこと"),
    0x001CE7E4: Data(DataType.String, 24, '???', "に、シンジが入院したが"),
    0x001CE7FC: Data(DataType.String, 32, '???', "大した事では無い、と言ったこと"),
    0x001CE81C: Data(DataType.String, 32, '???', "すぐに退院する、と言ったこと"),
    0x001CE83C: Data(DataType.String, 24, '???', "に、シンジが入院して"),
    0x001CE854: Data(DataType.String, 28, '???', "少し心配だ、と言ったこと"),
    0x001CE870: Data(DataType.String, 28, '???', "重傷のようだ、と言ったこと"),
    0x001CE88C: Data(DataType.String, 32, '???', "大丈夫だろうか、と言ったこと"),
    0x001CE8AC: Data(DataType.String, 28, '???', "死なないよね、と言ったこと"),
    0x001CE8C8: Data(DataType.String, 28, '???', "に、死んだシンジのことを"),
    0x001CE8E4: Data(DataType.String, 28, '???', "に、死んだアスカのことを"),
    0x001CE900: Data(DataType.String, 28, '???', "に、死んだトウジのことを"),
    0x001CE91C: Data(DataType.String, 28, '???', "に、死んだカヲルのことを"),
    0x001CE938: Data(DataType.String, 24, '???', "と、疎開が進んでいる"),
    0x001CE950: Data(DataType.String, 24, '???', "事について話したこと"),
    0x001CE968: Data(DataType.String, 24, '???', "と、疎開で生徒が減った"),
    0x001CE980: Data(DataType.String, 24, '???', "と、コンビニの品揃えの"),
    0x001CE998: Data(DataType.String, 24, '???', "悪さについて話したこと"),
    0x001CE9B0: Data(DataType.String, 24, '???', "と、コンビニから商品が"),
    0x001CE9C8: Data(DataType.String, 32, '???', "ほとんど消えていると話したこと"),
    0x001CE9E8: Data(DataType.String, 20, '???', "の話に同意したこと"),
    0x001CE9FC: Data(DataType.String, 20, '???', "の話に、大丈夫だ"),
    0x001CEA10: Data(DataType.String, 28, '???', "と希望的観測を述べたこと"),
    0x001CEA2C: Data(DataType.String, 20, '???', "と、ヒカリの家族の"),
    0x001CEA40: Data(DataType.String, 24, '???', "死について話したこと"),
    0x001CEA58: Data(DataType.String, 28, '???', "と、トウジの疎開について"),
    0x001CEA74: Data(DataType.String, 28, '???', "と、ケンスケ疎開について"),
    0x001CEA90: Data(DataType.String, 28, '???', "と、ヒカリの疎開について"),
    0x001CEAAC: Data(DataType.String, 20, '???', "と、レイの住まいが"),
    0x001CEAC0: Data(DataType.String, 32, '???', "倒壊した事について話したこと"),
    0x001CEAE0: Data(DataType.String, 12, '???', "の話を聞き"),
    0x001CEAEC: Data(DataType.String, 16, '???', "絶句したこと"),
    0x001CEAFC: Data(DataType.String, 16, '???', "胸を痛めたこと"),
    0x001CEB0C: Data(DataType.String, 16, '???', "寂しがったこと"),
    0x001CEB1C: Data(DataType.String, 16, '???', "に、今日は暑い"),
    0x001CEB2C: Data(DataType.String, 16, '???', "と話したこと"),
    0x001CEB3C: Data(DataType.String, 20, '???', "から、今日は暑いと"),
    0x001CEB50: Data(DataType.String, 24, '???', "言われ、同意したこと"),
    0x001CEB68: Data(DataType.String, 28, '???', "言われたが、否定したこと"),
    0x001CEB98: Data(DataType.String, 28, '???', "に、宿題はチャンとやった"),
    0x001CEBB4: Data(DataType.String, 24, '???', "に、宿題はやっていない"),
    0x001CEBCC: Data(DataType.String, 20, '???', "から宿題の話をされ"),
    0x001CEBE0: Data(DataType.String, 12, '???', "驚いたこと"),
    0x001CEBEC: Data(DataType.String, 16, '???', "に、妹の容態を"),
    0x001CEBFC: Data(DataType.String, 20, '???', "に、妹の調子は良い"),
    0x001CEC10: Data(DataType.String, 28, '???', "に、妹の調子はボチボチだ"),
    0x001CEC2C: Data(DataType.String, 28, '???', "から妹の容態を聞かれたが"),
    0x001CEC48: Data(DataType.String, 20, '???', "に、ミサトについて"),
    0x001CEC5C: Data(DataType.String, 28, '???', "からミサトの事を尋ねられ、"),
    0x001CEC78: Data(DataType.String, 20, '???', "ミサトを誉めたこと"),
    0x001CEC8C: Data(DataType.String, 24, '???', "良い人だ、と答えたこと"),
    0x001CECA4: Data(DataType.String, 28, '???', "特に何も無い、と答えたこと"),
    0x001CECC0: Data(DataType.String, 28, '???', "ミサトを軽くけなしたこと"),
    0x001CECDC: Data(DataType.String, 28, '???', "ミサトへの不満で返したこと"),
    0x001CECF8: Data(DataType.String, 28, '???', "からミサトの事を答えられ、"),
    0x001CED14: Data(DataType.String, 24, '???', "軽く相づちをうったこと"),
    0x001CED2C: Data(DataType.String, 24, '???', "に、加持へのノロケを"),
    0x001CED44: Data(DataType.String, 24, '???', "の加持へのノロケ話に"),
    0x001CED5C: Data(DataType.String, 16, '???', "耳を傾けたこと"),
    0x001CED6C: Data(DataType.String, 24, '???', "の加持へのノロケ話を"),
    0x001CED84: Data(DataType.String, 20, '???', "興味なく流したこと"),
    0x001CED98: Data(DataType.String, 24, '???', "に、加持への不信感を"),
    0x001CEDB0: Data(DataType.String, 20, '???', "に加持をけなされ"),
    0x001CEDC4: Data(DataType.String, 16, '???', "ムカついたこと"),
    0x001CEDD4: Data(DataType.String, 20, '???', "に、加持への不満を"),
    0x001CEDE8: Data(DataType.String, 16, '???', "爆発させたこと"),
    0x001CEDF8: Data(DataType.String, 24, '???', "から加持の話を聞かされ"),
    0x001CEE10: Data(DataType.String, 24, '???', "テキトーに同意したこと"),
    0x001CEE28: Data(DataType.String, 28, '???', "の加持に憤慨する様子を見て"),
    0x001CEE44: Data(DataType.String, 20, '???', "$bをなだめたこと"),
    0x001CEE58: Data(DataType.String, 20, '???', "に、ΑΤの調子を"),
    0x001CEE6C: Data(DataType.String, 24, '???', "にΑΤの調子を聞かれ"),
    0x001CEE84: Data(DataType.String, 24, '???', "好調だ、と答えたこと"),
    0x001CEE9C: Data(DataType.String, 24, '???', "普通だ、と答えたこと"),
    0x001CEEB4: Data(DataType.String, 24, '???', "調子悪い、と答えたこと"),
    0x001CEECC: Data(DataType.String, 20, '???', "に、学校での様子を"),
    0x001CEEE0: Data(DataType.String, 24, '???', "に学校での様子を聞かれ"),
    0x001CEEF8: Data(DataType.String, 24, '???', "楽しい、と答えたこと"),
    0x001CEF10: Data(DataType.String, 32, '???', "楽しい事は無い、と答えたこと"),
    0x001CEF30: Data(DataType.String, 16, '???', "の学校生活に"),
    0x001CEF40: Data(DataType.String, 20, '???', "発破をかけたこと"),
    0x001CEF54: Data(DataType.String, 20, '???', "気休めを言ったこと"),
    0x001CEF68: Data(DataType.String, 24, '???', "に、仕事が忙しいのか"),
    0x001CEF80: Data(DataType.String, 16, '???', "に、仕事は楽に"),
    0x001CEF90: Data(DataType.String, 28, '???', "こなせている、と答えたこと"),
    0x001CEFAC: Data(DataType.String, 24, '???', "に、仕事は残業無しで"),
    0x001CEFC4: Data(DataType.String, 20, '???', "に、仕事は問題無く"),
    0x001CEFD8: Data(DataType.String, 28, '???', "に、最近残業が増えている"),
    0x001CEFF4: Data(DataType.String, 24, '???', "に、仕事は今一番忙しい"),
    0x001CF00C: Data(DataType.String, 28, '???', "に、ネルフはどんな組織か"),
    0x001CF028: Data(DataType.String, 20, '???', "に、ネルフについて"),
    0x001CF03C: Data(DataType.String, 28, '???', "聞かれたので、答えたこと"),
    0x001CF058: Data(DataType.String, 20, '???', "に、エヴァについて"),
    0x001CF06C: Data(DataType.String, 20, '???', "に、使徒について"),
    0x001CF080: Data(DataType.String, 28, '???', "に、使徒について聞かれたが"),
    0x001CF09C: Data(DataType.String, 24, '???', "答えをはぐらかしたこと"),
    0x001CF0B4: Data(DataType.String, 28, '???', "に、人類補完計画について"),
    0x001CF0D0: Data(DataType.String, 28, '???', "聞かれたが、制止したこと"),
    0x001CF0EC: Data(DataType.String, 24, '???', "聞かれ、軽く教えたこと"),
    0x001CF104: Data(DataType.String, 24, '???', "聞かれ、深く教えたこと"),
    0x001CF11C: Data(DataType.String, 16, '???', "に、父について"),
    0x001CF12C: Data(DataType.String, 28, '???', "に、ゲンドウについて聞かれ"),
    0x001CF148: Data(DataType.String, 28, '???', "立派な人だ、と答えたこと"),
    0x001CF164: Data(DataType.String, 28, '???', "忙しい人だ、と答えたこと"),
    0x001CF180: Data(DataType.String, 28, '???', "最低の上司だ、と答えたこと"),
    0x001CF19C: Data(DataType.String, 32, '???', "よくわからない、と答えたこと"),
    0x001CF1BC: Data(DataType.String, 24, '???', "に、ゲンドウへの評価を"),
    0x001CF1D4: Data(DataType.String, 24, '???', "教えて貰い、礼を言った"),
    0x001CF1EC: Data(DataType.String, 28, '???', "のゲンドウを尋ねる様子に"),
    0x001CF208: Data(DataType.String, 24, '???', "思わず突っ込んだこと"),
    0x001CF220: Data(DataType.String, 16, '???', "に突っ込まれて"),
    0x001CF230: Data(DataType.String, 28, '???', "しどろもどろになったこと"),
    0x001CF24C: Data(DataType.String, 20, '???', "に、子供の様子を"),
    0x001CF260: Data(DataType.String, 24, '???', "に、子供の様子を聞かれ"),
    0x001CF278: Data(DataType.String, 32, '???', "何の心配も無い、と答えたこと"),
    0x001CF298: Data(DataType.String, 28, '???', "イイ感じだ、と答えたこと"),
    0x001CF2B4: Data(DataType.String, 28, '???', "まあ平均的だ、と答えたこと"),
    0x001CF2D0: Data(DataType.String, 32, '???', "ムラが有って困る、と答えたこと"),
    0x001CF2F0: Data(DataType.String, 28, '???', "調子が悪い、と答えたこと"),
    0x001CF30C: Data(DataType.String, 20, '???', "に、エヴァの調子を"),
    0x001CF320: Data(DataType.String, 28, '???', "に、エヴァの調子を聞かれ"),
    0x001CF33C: Data(DataType.String, 28, '???', "最高の状態だ、と答えたこと"),
    0x001CF358: Data(DataType.String, 24, '???', "問題無い、と答えたこと"),
    0x001CF370: Data(DataType.String, 32, '???', "問題が発生した、と答えたこと"),
    0x001CF390: Data(DataType.String, 28, '???', "芳しくない、と答えたこと"),
    0x001CF3AC: Data(DataType.String, 24, '???', "の諜報活動を牽制した"),
    0x001CF3C4: Data(DataType.String, 28, '???', "に、諜報活動の事を聞かれ"),
    0x001CF3E0: Data(DataType.String, 16, '???', "とぼけたこと"),
    0x001CF3F0: Data(DataType.String, 16, '???', "誤魔化したこと"),
    0x001CF400: Data(DataType.String, 28, '???', "そのうち話す、と答えたこと"),
    0x001CF41C: Data(DataType.String, 32, '???', "見ぬフリをしてくれと返したこと"),
    0x001CF43C: Data(DataType.String, 28, '???', "身の危険をつぶやいたこと"),
    0x001CF458: Data(DataType.String, 16, '???', "に、プリントを"),
    0x001CF468: Data(DataType.String, 12, '???', "託したこと"),
    0x001CF474: Data(DataType.String, 20, '???', "から、プリントを"),
    0x001CF488: Data(DataType.String, 24, '???', "渡され、嬉しかったこと"),
    0x001CF4A0: Data(DataType.String, 28, '???', "渡され、がっかりしたこと"),
    0x001CF4BC: Data(DataType.String, 20, '???', "の退院を喜んだこと"),
    0x001CF4D0: Data(DataType.String, 16, '???', "に退院を祝われ"),
    0x001CF4E0: Data(DataType.String, 16, '???', "嬉しかったこと"),
    0x001CF4F0: Data(DataType.String, 24, '???', "に退院を祝われたこと"),
    0x001CF508: Data(DataType.String, 20, '???', "に退院を祝われたが"),
    0x001CF51C: Data(DataType.String, 32, '???', "まだ本調子じゃないと答えたこと"),
    0x001CF53C: Data(DataType.String, 20, '???', "心から喜んだこと"),
    0x001CF550: Data(DataType.String, 16, '???', "の退院挨拶に"),
    0x001CF560: Data(DataType.String, 20, '???', "普通に返したこと"),
    0x001CF574: Data(DataType.String, 16, '???', "の退院挨拶を"),
    0x001CF584: Data(DataType.String, 20, '???', "無下に返したこと"),
    0x001CF598: Data(DataType.String, 20, '???', "の楽しそうな様子を"),
    0x001CF5AC: Data(DataType.String, 16, '???', "指摘したこと"),
    0x001CF5BC: Data(DataType.String, 24, '???', "のやる気に満ちた様子を"),
    0x001CF5D4: Data(DataType.String, 16, '???', "の真剣な表情を"),
    0x001CF5E4: Data(DataType.String, 20, '???', "の緊張した様子を"),
    0x001CF5F8: Data(DataType.String, 20, '???', "のホッとした様子を"),
    0x001CF60C: Data(DataType.String, 20, '???', "の不安めいた様子を"),
    0x001CF620: Data(DataType.String, 24, '???', "の悲しんでいる様子を"),
    0x001CF638: Data(DataType.String, 24, '???', "の気が緩んでいる様子を"),
    0x001CF650: Data(DataType.String, 24, '???', "の落胆している様子を"),
    0x001CF668: Data(DataType.String, 20, '???', "の不機嫌な様子を"),
    0x001CF67C: Data(DataType.String, 20, '???', "の怒っている様子を"),
    0x001CF690: Data(DataType.String, 20, '???', "の顔が赤かったので"),
    0x001CF6A4: Data(DataType.String, 24, '???', "の恥らっている様子を"),
    0x001CF6BC: Data(DataType.String, 20, '???', "に様子を尋ねられ"),
    0x001CF6D0: Data(DataType.String, 20, '???', "明るく肯定したこと"),
    0x001CF6E4: Data(DataType.String, 24, '???', "明るく誤魔化したこと"),
    0x001CF6FC: Data(DataType.String, 20, '???', "明るく否定したこと"),
    0x001CF710: Data(DataType.String, 20, '???', "真剣に肯定したこと"),
    0x001CF724: Data(DataType.String, 16, '???', "否定したこと"),
    0x001CF734: Data(DataType.String, 24, '???', "気まずく肯定したこと"),
    0x001CF74C: Data(DataType.String, 24, '???', "気まずく誤魔化したこと"),
    0x001CF764: Data(DataType.String, 24, '???', "気まずく否定したこと"),
    0x001CF77C: Data(DataType.String, 24, '???', "沈みがちに肯定したこと"),
    0x001CF794: Data(DataType.String, 28, '???', "沈みがちに誤魔化したこと"),
    0x001CF7B0: Data(DataType.String, 24, '???', "沈みがちに否定したこと"),
    ...
    0x001CF814: Data(DataType.String, 24, '???', "に様子を尋ねられたが、"),
    ...
    0x001CF9B8: Data(DataType.String, 28, '???', "行こう、と持ちかけたこと"),
    0x001CF9D4: Data(DataType.String, 28, '???', "ネルフ本部へ向かったこと"),
    0x001CF9F0: Data(DataType.String, 28, '???', "からのネルフ登庁の誘いを"),
    0x001CFA0C: Data(DataType.String, 16, '???', "とネルフ本部へ"),
    0x001CFA1C: Data(DataType.String, 12, '???', "急いだこと"),
    0x001CFA28: Data(DataType.String, 24, '???', "に、アイテムの交換を"),
    0x001CFA40: Data(DataType.String, 16, '???', "持ちかけたこと"),
    0x001CFA50: Data(DataType.String, 28, '???', "に、交換出来るアイテムは"),
    0x001CFA6C: Data(DataType.String, 28, '???', "持っていない、と伝えたこと"),
    0x001CFA88: Data(DataType.String, 24, '???', "からのアイテム交換の"),
    0x001CFAA0: Data(DataType.String, 20, '???', "誘いを、断ったこと"),
    0x001CFAB4: Data(DataType.String, 20, '???', "誘いに乗ったこと"),
    0x001CFAC8: Data(DataType.String, 20, '???', "とのアイテム交換を"),
    0x001CFADC: Data(DataType.String, 28, '???', "やっぱりいい、と断ったこと"),
    0x001CFAF8: Data(DataType.String, 20, '???', "とのアイテム交換で"),
    0x001CFB0C: Data(DataType.String, 24, '???', "欲しい物を選んだこと"),
    0x001CFB24: Data(DataType.String, 24, '???', "選ばれた物を断ったこと"),
    0x001CFB3C: Data(DataType.String, 20, '???', "交渉成立したこと"),
    ...
    0x001CFB8C: Data(DataType.String, 20, '???', "雑誌を読んだこと"),
    ...
    0x001CFBD8: Data(DataType.String, 20, '???', "に話しかけたこと"),
    0x001CFBEC: Data(DataType.String, 28, '???', "から話しかけられ、ベッド"),
    0x001CFC08: Data(DataType.String, 28, '???', "から立ち上がり応対したこと"),
    0x001CFC24: Data(DataType.String, 24, '???', "から話しかけられたが"),
    0x001CFC3C: Data(DataType.String, 16, '???', "追い払ったこと"),
    0x001CFC4C: Data(DataType.String, 28, '???', "ぼんやりとくつろいだこと"),
    0x001CFC68: Data(DataType.String, 24, 'drinking juice', "ジュースを飲んだこと"),
    0x001CFC80: Data(DataType.String, 28, '???', "から話しかけられ、ベンチ"),
    0x001CFC9C: Data(DataType.String, 28, '???', "に、ハーモニクステストを"),
    0x001CFCB8: Data(DataType.String, 16, '???', "依頼したこと"),
    0x001CFCC8: Data(DataType.String, 28, '???', "からハーモニクステストを"),
    0x001CFCE4: Data(DataType.String, 28, '???', "依頼されたが、断ったこと"),
    0x001CFD00: Data(DataType.String, 24, '???', "のハーモニクステストを"),
    0x001CFD18: Data(DataType.String, 24, '???', "のハーモニクステストの"),
    0x001CFD30: Data(DataType.String, 24, '???', "結果に、満足したこと"),
    0x001CFD48: Data(DataType.String, 24, '???', "結果に、安心したこと"),
    0x001CFD60: Data(DataType.String, 24, '???', "結果に、落胆したこと"),
    0x001CFD78: Data(DataType.String, 20, '???', "を屋上に誘ったこと"),
    0x001CFD8C: Data(DataType.String, 24, '???', "からの屋上への誘いに"),
    0x001CFDA4: Data(DataType.String, 12, '???', "乗ったこと"),
    0x001CFDB0: Data(DataType.String, 16, 'from the roof with', "と、屋上から"),
    0x001CFDC0: Data(DataType.String, 20, '???', "階下に戻ったこと"),
    0x001CFDD4: Data(DataType.String, 20, '???', "をネルフの屋外へ"),
    0x001CFDE8: Data(DataType.String, 12, '???', "誘ったこと"),
    0x001CFDF4: Data(DataType.String, 24, '???', "からのネルフ屋外への"),
    0x001CFE0C: Data(DataType.String, 32, '???', "誘いを、あいまいに断ったこと"),
    0x001CFE2C: Data(DataType.String, 20, '???', "と、ネルフ屋外から"),
    0x001CFE40: Data(DataType.String, 20, '???', "本部内へ戻ったこと"),
    0x001CFE54: Data(DataType.String, 24, '???', "に、シンクロ技能訓練を"),
    0x001CFE6C: Data(DataType.String, 12, '???', "参謀技能の"),
    0x001CFE78: Data(DataType.String, 16, '???', "訓練をしたこと"),
    0x001CFE88: Data(DataType.String, 12, '???', "開発技能の"),
    ...
    0x001CFEEC: Data(DataType.String, 24, '???', "街から逃げ出したこと"),
    0x001CFF04: Data(DataType.String, 16, '???', "顔を洗ったこと"),
    0x001CFF14: Data(DataType.String, 28, '???', "自己啓発して奮起したこと"),
    0x001CFF30: Data(DataType.String, 28, '???', "自己嫌悪して落ち込んだこと"),
    ...
    0x001D000C: Data(DataType.String, 24, '???', "アイテムを選ばせたこと"),
    0x001D0024: Data(DataType.String, 16, '???', "からアイテムを"),
    0x001D0034: Data(DataType.String, 28, '???', "ねだられたが、断ったこと"),
    0x001D0050: Data(DataType.String, 24, '???', "に、欲しいアイテムを"),
    0x001D0068: Data(DataType.String, 28, '???', "に、欲しいアイテムが無く"),
    0x001D0084: Data(DataType.String, 28, '???', "やっぱりいい、と言ったこと"),
    0x001D00A0: Data(DataType.String, 24, '???', "の欲しがったアイテムを"),
    0x001D00B8: Data(DataType.String, 16, 'giving to $b', "$bにあげたこと"),
    0x001D00C8: Data(DataType.String, 24, '???', "の欲しがったアイテムは"),
    0x001D00E0: Data(DataType.String, 24, '???', "渡せない、と断ったこと"),
    0x001D00F8: Data(DataType.String, 20, '???', "からアイテムを貰い"),
    0x001D010C: Data(DataType.String, 20, '???', "に、体力回復用の"),
    0x001D0120: Data(DataType.String, 20, '???', "に、喉の渇きを癒す"),
    0x001D0134: Data(DataType.String, 20, '???', "に、目を覚まさせる"),
    0x001D0148: Data(DataType.String, 12, '???', "に、嫌いな"),
    0x001D0154: Data(DataType.String, 20, '???', "に、色欲を満たす"),
    0x001D0168: Data(DataType.String, 20, '???', "に、物欲を満たす"),
    0x001D017C: Data(DataType.String, 12, '???', "に、金目の"),
    0x001D0188: Data(DataType.String, 20, '???', "に、名誉欲を満たす"),
    0x001D019C: Data(DataType.String, 20, '???', "に、力欲を満たす"),
    0x001D01B0: Data(DataType.String, 28, '???', "に、皆に好かれたい時用の"),
    0x001D01CC: Data(DataType.String, 28, '???', "に、正義をなしたい時用の"),
    0x001D01E8: Data(DataType.String, 24, '???', "に、恋に生きたい時用の"),
    0x001D0200: Data(DataType.String, 28, '???', "に、何もしたくない時用の"),
    0x001D021C: Data(DataType.String, 28, '???', "に、トイレに行きたい時の"),
    0x001D0238: Data(DataType.String, 28, '???', "に、友情に生きたい時用の"),
    0x001D0254: Data(DataType.String, 28, '???', "に、親愛に生きたい時用の"),
    0x001D0270: Data(DataType.String, 28, 'presenting an item', "アイテムを差し出したこと"),
    0x001D028C: Data(DataType.String, 24, '???', "のシンクロ技能訓練を"),
    0x001D02A4: Data(DataType.String, 24, '???', "のシンクロ技能訓練の"),
    0x001D02BC: Data(DataType.String, 20, '???', "に、最近の出来事を"),
    0x001D02D0: Data(DataType.String, 20, '???', "に、他人の出来事を"),
    0x001D02E4: Data(DataType.String, 20, '???', "に、最近の愚痴を"),
    0x001D02F8: Data(DataType.String, 20, '???', "に、以前の出来事を"),
    0x001D030C: Data(DataType.String, 20, '???', "観葉植物を見たこと"),
    ...
    0x001D0348: Data(DataType.String, 20, '???', "荷物を預けたこと"),
    0x001D035C: Data(DataType.String, 16, 'from locker', "ロッカーから"),
    0x001D036C: Data(DataType.String, 24, '???', "荷物を取り出したこと"),
    ...
    0x001D03AC: Data(DataType.String, 12, '???', "の話に、"),
    0x001D03B8: Data(DataType.String, 32, '???', "テキトーに相づちをうったこと"),
    0x001D03D8: Data(DataType.String, 20, '???', "の話に乗ったこと"),
    0x001D03EC: Data(DataType.String, 28, '???', "それだけか、と言ったこと"),
    0x001D0408: Data(DataType.String, 16, '???', "に、最近の事を"),
    0x001D0418: Data(DataType.String, 12, 'thinking', "教えたこと"),
    0x001D0424: Data(DataType.String, 16, '???', "に、今の体調を"),
    0x001D0434: Data(DataType.String, 20, '???', "に、最近の調子を"),
    0x001D0448: Data(DataType.String, 24, '???', "に、お金をねだったこと"),
    0x001D0460: Data(DataType.String, 24, '???', "に、お金を渡したこと"),
    0x001D0478: Data(DataType.String, 20, '???', "からのお金の無心に"),
    0x001D048C: Data(DataType.String, 32, '???', "持ち合わせが無い、と断ったこと"),
    0x001D04AC: Data(DataType.String, 20, '???', "からのお金の無心を"),
    0x001D04C0: Data(DataType.String, 24, '???', "に、不満をぶつけたこと"),
    0x001D04D8: Data(DataType.String, 24, '???', "からぶつけられた不満を"),
    0x001D04F0: Data(DataType.String, 24, 'listening quietly', "黙って聞いていたこと"),
    0x001D0508: Data(DataType.String, 24, '???', "からぶつけられた不満に"),
    0x001D0520: Data(DataType.String, 24, '???', "文句を言い返したこと"),
    0x001D0538: Data(DataType.String, 28, '???', "から不満をぶつけられたが"),
    0x001D0554: Data(DataType.String, 24, '???', "相手にしなかったこと"),
    0x001D056C: Data(DataType.String, 20, '???', "を挑発するセリフを"),
    0x001D0580: Data(DataType.String, 12, '???', "吐いたこと"),
    0x001D058C: Data(DataType.String, 20, '???', "から挑発されたが"),
    0x001D05A0: Data(DataType.String, 16, '???', "から挑発され"),
    0x001D05B0: Data(DataType.String, 28, '???', "馬鹿にするように笑ったこと"),
    0x001D05CC: Data(DataType.String, 16, '???', "のΑΤの低調を"),
    0x001D05DC: Data(DataType.String, 24, '???', "からΑΤ低調を叱られ"),
    0x001D05F4: Data(DataType.String, 20, '???', "力なく謝ったこと"),
    0x001D0608: Data(DataType.String, 24, '???', "への好意を表したこと"),
    0x001D0620: Data(DataType.String, 24, '???', "から友好的に接せられ"),
    0x001D0638: Data(DataType.String, 24, '???', "好意的に応対したこと"),
    0x001D0650: Data(DataType.String, 28, '???', "邪険な態度で応対したこと"),
    0x001D066C: Data(DataType.String, 16, '???', "に、気さくに"),
    0x001D067C: Data(DataType.String, 28, '???', "から気さくに話しかけられ"),
    0x001D0698: Data(DataType.String, 16, '???', "のΑΤの高さを"),
    0x001D06A8: Data(DataType.String, 20, '???', "感心してみせたこと"),
    0x001D06BC: Data(DataType.String, 28, '???', "からΑΤの高さを感心され"),
    0x001D06D8: Data(DataType.String, 12, 'looking at', "を見たこと"),
    0x001D06E4: Data(DataType.String, 24, '???', "を好意的な目で見たこと"),
    0x001D06FC: Data(DataType.String, 28, '???', "から好意的な目で見られて"),
    0x001D0718: Data(DataType.String, 24, '???', "軽い挨拶で返したこと"),
    0x001D0730: Data(DataType.String, 20, '???', "から好意的な目で"),
    0x001D0744: Data(DataType.String, 28, 'ignoring the stares', "見られたが、無視したこと"),
    0x001D0760: Data(DataType.String, 20, '???', "を何気なく見たこと"),
    0x001D0774: Data(DataType.String, 24, '???', "から何気なく見られて"),
    0x001D078C: Data(DataType.String, 24, '???', "気まずい思いをしたこと"),
    0x001D07A4: Data(DataType.String, 24, '???', "から何気なく見られたが"),
    0x001D07BC: Data(DataType.String, 24, '???', "を悪意を込めて見たこと"),
    0x001D07D4: Data(DataType.String, 28, '???', "の視線に悪意を感じたので"),
    0x001D07F0: Data(DataType.String, 16, 'glaring back', "睨み返したこと"),
    0x001D0800: Data(DataType.String, 20, 'averting their eyes', "目を逸らしたこと"),
    0x001D0814: Data(DataType.String, 24, '???', "の視線に悪意を感じたが"),
    0x001D082C: Data(DataType.String, 20, 'flaring up at', "食って掛かったこと"),
    0x001D0840: Data(DataType.String, 24, '???', "に対して微笑んだこと"),
    0x001D0858: Data(DataType.String, 24, '???', "に対して同意したこと"),
    ...
    0x001D089C: Data(DataType.String, 24, '???', "に対して、あいまいに"),
    0x001D08B4: Data(DataType.String, 24, '???', "誤魔化す態度をしたこと"),
    0x001D08CC: Data(DataType.String, 24, 'averting their eyes from', "から目を逸らしたこと"),
    0x001D08E4: Data(DataType.String, 16, '???', "に、うわの空な"),
    0x001D08F4: Data(DataType.String, 16, '???', "態度をしたこと"),
    0x001D0904: Data(DataType.String, 16, 'being huffy', "ムッとしたこと"),
    0x001D0914: Data(DataType.String, 20, '???', "に対して、しらけた"),
    ...
    0x001D0970: Data(DataType.String, 20, '???', "の心配をしたこと"),
    0x001D0984: Data(DataType.String, 20, 'feeling unsettled', "不快感を持ったこと"),
    0x001D0998: Data(DataType.String, 20, '???', "の事を、好意的に"),
    0x001D09AC: Data(DataType.String, 12, 'sensing', "感じたこと"),
    0x001D09B8: Data(DataType.String, 16, '???', "ひるんだこと"),
    0x001D09C8: Data(DataType.String, 24, '???', "自滅促進プログラムの"),
    0x001D09E0: Data(DataType.String, 20, '???', "作成を行ったこと"),
    0x001D09F4: Data(DataType.String, 24, '???', "自滅促進プログラムを"),
    0x001D0A0C: Data(DataType.String, 16, '???', "実行したこと"),
    0x001D0A1C: Data(DataType.String, 20, 'unison training with', "と、ユニゾン訓練を"),
    0x001D0A30: Data(DataType.String, 16, '???', "シールはがしに"),
    0x001D0A40: Data(DataType.String, 20, 'challenging', "チャレンジしたこと"),
    0x001D0A54: Data(DataType.String, 20, 'a sheet of stickers', "シールのシートを"),
    0x001D0A68: Data(DataType.String, 20, '???', "に、懸賞の応募を"),
    0x001D0A7C: Data(DataType.String, 24, '???', "京都への出張計画書の"),
    0x001D0A94: Data(DataType.String, 24, '???', "青葉に電話をかけたこと"),
    0x001D0AAC: Data(DataType.String, 24, '???', "をデートに誘ったこと"),
    0x001D0AC4: Data(DataType.String, 20, '???', "を問いただしたこと"),
    0x001D0AD8: Data(DataType.String, 16, '???', "を誘ったこと"),
    0x001D0AE8: Data(DataType.String, 20, '???', "力を解放したこと"),
    0x001D0AFC: Data(DataType.String, 20, '???', "の容態を聞いたこと"),
    0x001D0B10: Data(DataType.String, 24, '???', "に、レイが入院したが"),
    0x001D0B28: Data(DataType.String, 20, 'Rei is hospitalized', "に、レイが入院して"),
    0x001D0B3C: Data(DataType.String, 24, '???', "に、アスカが入院したが"),
    0x001D0B54: Data(DataType.String, 24, 'Asuka is hospitalized', "に、アスカが入院して"),
    0x001D0B6C: Data(DataType.String, 24, '???', "に、トウジが入院したが"),
    0x001D0B84: Data(DataType.String, 24, 'Toji is hospitalized', "に、トウジが入院して"),
    0x001D0B9C: Data(DataType.String, 24, '???', "に、カヲルが入院したが"),
    ...
    0x001D0BFC: Data(DataType.String, 32, '???', "エヴァ支援施設修復効率見直しの"),
	...
	0x001D135C: Data(DataType.String, 8, (0x24, 0x62, 0x82, 0xC9, 0x00, 0x00, 0x00, 0x00), "$bに"),
    0x001D1364: Data(DataType.String, 4, (0x82, 0xAA, 0x00, 0x00), "が"),
    0x001D1368: Data(DataType.String, 44, '???', "$aは%s、\n%sの出来事を%s。$n%s%s%s\n%s%sを。"),
    0x001D13A4: Data(DataType.String, 4, '...', "…"),
    0x001D13A8: Data(DataType.String, 8, 'and company', "たち"),
    0x001D13B0: Data(DataType.String, 8, '$a', "自分"),
    ...
    0x001D1B20: Data(DataType.String, 16, '???', "○話数:%d…%s"),
    0x001D1B30: Data(DataType.String, 12, '???', "○出撃:%s"),
    0x001D1B3C: Data(DataType.String, 32, '○ Tokyo-3 Facility Operating Rate', "○第３新東京市の施設稼動率:%d％"),
    0x001D1B5C: Data(DataType.String, 32, '???', "○ジオフロントの施設稼動率:%d％"),
    0x001D1BB4: Data(DataType.String, 12, '???', "　ＡＴ変更"),
    0x001D1BD8: Data(DataType.String, 32, '???', "耐久%d,シンクロ%d,速度%dM/秒"),
    0x001D1C00: Data(DataType.String, 16, '???', "ＡＴ＋強度補正"),
    0x001D1C10: Data(DataType.String, 16, '???', "ＡＴ−強度補正"),
    0x001D1C20: Data(DataType.String, 32, '???', "誰のパラメータを変更しますか？"),
    0x001D1C40: Data(DataType.String, 32, '???', "どのパラメータを変更しますか？"),
    0x001D1C64: Data(DataType.String, 28, '???', "誰に対して行ないますか？"),
    0x001D1C80: Data(DataType.String, 36, '???', "記憶強度倍率を％で指定して下さい"),
    ...
    0x001D1FA4: Data(DataType.String, 8, '???', "ヴァへ"),
    0x001D1FB8: Data(DataType.String, 8, '???', "戦立案"),
    0x001D1FE4: Data(DataType.String, 8, '???', "%1i選択"),
    ...
    0x001D2088: Data(DataType.String, 12, '???', "ありえない"),
    0x001D2120: Data(DataType.String, 16, '???', "作戦伝達画面"),
    0x001D2160: Data(DataType.String, 20, '???', "%1iエヴァ配置確認へ"),
    0x001D21E4: Data(DataType.String, 32, '???', "入院中の\n%sは\n召喚されました。"),
    0x001D2250: Data(DataType.String, 16, '???', "出撃メンバー"),
    0x001D2264: Data(DataType.String, 12, 'Damage', "ダメージ"),
    0x001D2278: Data(DataType.String, 12, '???', "\n国連軍:%d"),
    0x001D2284: Data(DataType.String, 20, '\nTokyo-3:%d', "\n第３新東京市:%d"),
    0x001D23A4: Data(DataType.String, 16, '???', "自動作戦設定"),
    0x001D23EC: Data(DataType.String, 8, '???', "ヴァへ"),
    0x001D23FC: Data(DataType.String, 8, '○ %s', "○%s"),
    0x001D2404: Data(DataType.String, 16, '○ Eva%s、', "○エヴァ%s、"),
    0x001D2414: Data(DataType.String, 12, '???', "○入院:%s"),
    0x001D2420: Data(DataType.String, 16, '● View screen', "●画面を見る"),
    0x001D255C: Data(DataType.String, 40, '???', "戦闘は終了していません！バグ入ってます"),
    0x001D2584: Data(DataType.String, 24, '???', "カヲルと和解しました"),
    0x001D259C: Data(DataType.String, 20, '???', "戦闘に敗北しました"),
    0x001D25B0: Data(DataType.String, 24, '???', "カヲルを殺害しました"),
    ...
    0x001D28C8: Data(DataType.String, 8, '???', "未実装"),
    0x001D2910: Data(DataType.String, 12, '???', "装備なし"),
    ...
    0x001D2C8C: Data(DataType.String, 16, 'eva: 2P Kick', "eva;２Ｐキック"),
    ...
    0x001D306C: Data(DataType.String, 28, '???', "neweva:プログダガー切り裂き"),
    0x001D3088: Data(DataType.String, 28, '???', "neweva:プログダガー突き刺し"),
    0x001D30A4: Data(DataType.String, 24, '???', "neweva:インパクトボルト"),
    0x001D30BC: Data(DataType.String, 20, '???', "eva:ＡＴＦアタック"),
    0x001D30D0: Data(DataType.String, 24, '???', "eva:マステマ斬り付け"),
    0x001D30E8: Data(DataType.String, 20, '???', "eva:マステマ射撃"),
    ...
    0x001D3190: Data(DataType.String, 24, '???', "eva:真暴走用ATFアタック"),
    0x001D31A8: Data(DataType.String, 24, '???', "eva5:ロンギヌス突き刺し"),
    0x001D31C0: Data(DataType.String, 24, '???', "eva:マゴロクソード斬り"),
    0x001D31D8: Data(DataType.String, 24, '???', "eva:マゴロクソード突き"),
    0x001D31F0: Data(DataType.String, 12, '???', "gagiel:登場"),
    0x001D31FC: Data(DataType.String, 16, '???', "gagiel:体当たり"),
    0x001D320C: Data(DataType.String, 16, '???', "gagiel:噛み付き"),
    0x001D321C: Data(DataType.String, 32, '???', "eva02:対ガギエルプログナイフ"),
    0x001D323C: Data(DataType.String, 16, '???', "sandalphon:登場"),
    0x001D324C: Data(DataType.String, 20, '???', "sandalphon:体当たり"),
    0x001D3260: Data(DataType.String, 20, '???', "sandalphon:抱きつき"),
    0x001D3274: Data(DataType.String, 32, '???', "eva_d:対sandalphonプログナイフ"),
    0x001D3294: Data(DataType.String, 12, '???', "leliel:登場"),
    0x001D32A0: Data(DataType.String, 16, '???', "leliel:影上昇"),
    0x001D32B0: Data(DataType.String, 28, '???', "arael:精神攻撃(ダメージ大)"),
    0x001D32CC: Data(DataType.String, 28, '???', "arael:精神攻撃(ダメージ小)"),
    ...
    0x001D3330: Data(DataType.String, 16, '???', "全デモ自動実行"),
    0x001D3340: Data(DataType.String, 20, '???', "全デモ簡易自動実行"),
    0x001D3354: Data(DataType.String, 20, '???', "全デモロードテスト"),
    0x001D3368: Data(DataType.String, 32, '???', "処理落ちテスト（開発機専用）"),
    0x001D3388: Data(DataType.String, 20, '???', "　時間帯  　　:%s"),
    ...
    0x001D33E4: Data(DataType.String, 20, '???', "　左又は右　　:%s"),
    ...
    0x001D34BC: Data(DataType.String, 36, '???', "対イスラフェルWでは2対エヴァが必要"),
    0x001D34E0: Data(DataType.String, 20, '???', "同じエヴァ2体は不可"),
    ...
    0x001D3ACC: Data(DataType.String, 20, '???', "再生を止めています"),
    0x001D3AE0: Data(DataType.String, 32, '???', "表示開始デモを選んでください。"),
    0x001D3B00: Data(DataType.String, 36, '???', "表示するエヴァを選んでください。"),
    0x001D3B24: Data(DataType.String, 12, 'Random', "ランダム"),
    0x001D3D74: Data(DataType.String, 28, '???', "デモデータは新規(btdemo)"),
    0x001D3D90: Data(DataType.String, 28, '???', "デモデータは従来(btldemo)"),
    0x001D3DAC: Data(DataType.String, 32, '???', "新規デモは従来データでは不可"),
    0x001D41A4: Data(DataType.String, 16, 'You betrayed me!', "裏切ったな！"),
    0x001D41B4: Data(DataType.String, 28, '???', "僕の気持ちを踏みにじった"),
    ...
    0x001D41F8: Data(DataType.String, 24, '???', "君も助けてくれないんだ"),
    0x001D4210: Data(DataType.String, 16, 'It\'s too convenient!', "勝手過ぎるよ！"),
    0x001D4220: Data(DataType.String, 28, '???', "なぜそんな事が言えるの？"),
    ...
    0x001D4260: Data(DataType.String, 20, '???', "僕も好きだったのに"),
    0x001D4274: Data(DataType.String, 8, 'No!', "違う！"),
    0x001D427C: Data(DataType.String, 12, '...I guess you\'re right.', "…そうかい"),
    0x001D4288: Data(DataType.String, 20, '???', "なぜ僕を傷つけるの"),
    0x001D429C: Data(DataType.String, 24, '???', "だってそうじゃないか"),
    0x001D42B4: Data(DataType.String, 20, 'What should I do?', "どうすればいいの"),
    0x001D42C8: Data(DataType.String, 20, '???', "こんなの嘘だよね"),
    0x001D42DC: Data(DataType.String, 24, '???', "友達じゃなかったの？"),
    0x001D42F4: Data(DataType.String, 20, '???', "そんなの関係ないよ"),
    0x001D4308: Data(DataType.String, 24, '???', "君には嫌われたくない"),
    0x001D4320: Data(DataType.String, 24, '???', "出会って嬉しかったのに"),
    ...
    0x001D4384: Data(DataType.String, 24, '???', "一緒にやり直せばいい"),
    0x001D439C: Data(DataType.String, 24, '???', "君が使徒でも構わない"),
    0x001D43B4: Data(DataType.String, 20, '???', "君は必要な人なんだ"),
    0x001D43C8: Data(DataType.String, 28, '???', "そんなの逃げでしかないよ"),
    0x001D43E4: Data(DataType.String, 24, '???', "僕ともう一度友達に…"),
    0x001D43FC: Data(DataType.String, 12, 'That\'s unfair', "卑怯だよ"),
    0x001D4408: Data(DataType.String, 12, 'Why?', "どうして？"),
    0x001D4414: Data(DataType.String, 24, '???', "何で僕の前に現われたの"),
    0x001D442C: Data(DataType.String, 24, '???', "そんなの信用できない"),
    0x001D4444: Data(DataType.String, 20, '???', "いっそ、殺してよ"),
    ...
    0x001D4478: Data(DataType.String, 28, '???', "行くなら本気で僕を倒せよ"),
    ...
    0x001D44F4: Data(DataType.String, 16, '???', "そんなの嫌だ"),
    ...
    0x001D46B8: Data(DataType.String, 12, '???', "装備不可"),
    ...
    0x001D471C: Data(DataType.String, 12, '???', "近接(短)"),
    0x001D4728: Data(DataType.String, 16, '???', "近接(短〜長)"),
    0x001D4738: Data(DataType.String, 12, '???', "近接(長)"),
    0x001D4744: Data(DataType.String, 8, '???', "%sｍ"),
    0x001D474C: Data(DataType.String, 16, '%1iGo Back %2iGo Back', "%1i戻る %2i戻る"),
    0x001D475C: Data(DataType.String, 12, '???', "影響無し"),
    0x001D4768: Data(DataType.String, 8, '%s／5', "%s／５"),
    0x001D4770: Data(DataType.String, 8, '???', "%s度"),
    0x001D4778: Data(DataType.String, 12, '???', "%s度(片側)"),
    0x001D47DC: Data(DataType.String, 8, 'Front', "正面"),
    0x001D47E4: Data(DataType.String, 8, '???', "斜め前"),
    0x001D47EC: Data(DataType.String, 16, '???', "正面〜斜め前"),
    0x001D47FC: Data(DataType.String, 8, '???', "真横"),
    0x001D4804: Data(DataType.String, 16, '???', "斜め前〜真横"),
    0x001D4814: Data(DataType.String, 12, '???', "正面〜真横"),
    0x001D4C68: Data(DataType.String, 24, '???', "空きの電源ビルがない"),
    0x001D4C80: Data(DataType.String, 24, '???', "%sをact_powerにしました"),
    0x001D4C98: Data(DataType.String, 28, '???', "空でない武器庫ビルがない"),
    0x001D4CB4: Data(DataType.String, 28, '???', "%sをact_weaponにしました"),
    0x001D4D28: Data(DataType.String, 28, '???', "%sをact_attackにしました"),
    0x001D4D44: Data(DataType.String, 20, '???', "%sを%sにしました"),
    ...
    0x001D526C: Data(DataType.String, 20, '???', "最初の作戦設定済み"),
    0x001D5280: Data(DataType.String, 24, 'A.T. Field Attack', "ATフィールドアタック"),
    0x001D5298: Data(DataType.String, 20, '???', "ATフィールド増幅"),
    0x001D52AC: Data(DataType.String, 16, '???', "稼働時間の延長"),
    ...
    0x001D6538: Data(DataType.String, 8, '???', "？？？"),
    ...
    0x001D6884: Data(DataType.String, 16, '???', "意識不明の重体"),
    ...
    0x001D6C54: Data(DataType.String, 12, '???', "決裂勝利"),
    ...
    0x001D77D8: Data(DataType.String, 16, '???', "怖くなんかない"),
    0x001D77E8: Data(DataType.String, 20, '???', "嫌われるのは嫌だ"),
    0x001D77FC: Data(DataType.String, 24, '???', "他人から嫌われてもいい"),
    0x001D7814: Data(DataType.String, 20, '???', "自分ばかり悪くない"),
    0x001D7828: Data(DataType.String, 20, '???', "悪いのは自分だ…"),
    0x001D783C: Data(DataType.String, 16, '???', "誰だってそうだ"),
    0x001D784C: Data(DataType.String, 16, '???', "諦めも必要だ"),
    0x001D785C: Data(DataType.String, 24, '???', "自分を守って何が悪い！"),
    0x001D7874: Data(DataType.String, 8, 'No!', "違う！"),
    0x001D787C: Data(DataType.String, 20, 'What should I do?', "どうすればいい？"),
    0x001D7890: Data(DataType.String, 24, '???', "嘘だ、いい事なんかない"),
    0x001D78A8: Data(DataType.String, 20, '???', "変化なんか要らない"),
    0x001D78BC: Data(DataType.String, 20, 'And yet people change', "それでも人は変わる"),
    0x001D78D0: Data(DataType.String, 24, '???', "後悔しない人間はいない"),
    0x001D78E8: Data(DataType.String, 28, '???', "そんな事思い出させないで"),
    0x001D7904: Data(DataType.String, 16, '???', "怖いと思ってる"),
    0x001D7914: Data(DataType.String, 24, '???', "心を覗かれるのは怖い"),
    0x001D792C: Data(DataType.String, 28, '???', "心が誰にでも見えればいい"),
    0x001D7948: Data(DataType.String, 24, '???', "僕は誰も傷つけてない！"),
    0x001D7960: Data(DataType.String, 24, '???', "傷つけた事はあると思う"),
    0x001D7978: Data(DataType.String, 28, '???', "みんな心を隠しすぎるんだ"),
    0x001D7994: Data(DataType.String, 20, '???', "みんな嘘つきなんだ"),
    0x001D79A8: Data(DataType.String, 28, '???', "僕が傷つくのは自分のせい"),
    0x001D79C4: Data(DataType.String, 28, '???', "僕が傷つくのは他人のせい"),
    0x001D79E0: Data(DataType.String, 28, '???', "でも、人を好きになりたい"),
    0x001D79FC: Data(DataType.String, 20, '???', "他人といるのが怖い"),
    0x001D7A10: Data(DataType.String, 28, '???', "だからきっかけを待ってる"),
    0x001D7A2C: Data(DataType.String, 28, '???', "僕だって心を隠したくない"),
    0x001D7A48: Data(DataType.String, 28, '???', "違う、そんな事していない"),
    0x001D7A64: Data(DataType.String, 28, '???', "人と上手くやっていく為だ"),
    0x001D7A80: Data(DataType.String, 24, '???', "他人なんてどうでもいい"),
    0x001D7A98: Data(DataType.String, 24, '???', "変えることはできない"),
    0x001D7AB0: Data(DataType.String, 20, '???', "自分だけで充分だ"),
    0x001D7AC4: Data(DataType.String, 20, '???', "自分を殺せって事？"),
    0x001D7AD8: Data(DataType.String, 20, '???', "僕は変われるの？"),
    0x001D7AEC: Data(DataType.String, 16, '???', "君は他人なの？"),
    0x001D7AFC: Data(DataType.String, 20, '???', "君は僕自身だろう？"),
    0x001D7B10: Data(DataType.String, 16, '???', "変わる事が怖い"),
    0x001D7B20: Data(DataType.String, 20, '???', "正しいわけじゃない"),
    0x001D7B34: Data(DataType.String, 16, '???', "僕は変わりたい"),
    0x001D7B44: Data(DataType.String, 24, '???', "周りは変わらないの？"),
    0x001D7B5C: Data(DataType.String, 24, '???', "何で僕を傷つけるんだ"),
    ...
    0x001D7BF4: Data(DataType.String, 20, '???', "逃げてなんかない"),
    ...
    0x001D7C54: Data(DataType.String, 24, '???', "一人なのは自分のせい？"),
    0x001D7C6C: Data(DataType.String, 24, '???', "一人なのは他人のせい？"),
    0x001D7C84: Data(DataType.String, 28, '???', "こんな事、望んでいない…"),
    0x001D7CA0: Data(DataType.String, 16, '???', "これで構わない"),
    0x001D7CB0: Data(DataType.String, 16, '???', "他人に頼らない"),
    ...
    0x001D7CF0: Data(DataType.String, 28, '???', "こんなに苦しんでいるのに"),
    0x001D7D0C: Data(DataType.String, 20, '???', "他人って冷たい…"),
    0x001D7D20: Data(DataType.String, 24, '???', "誰か近くにいてほしい"),
    0x001D7D38: Data(DataType.String, 24, '???', "他人は苦しんでいない"),
    ...
    0x001D7EC8: Data(DataType.String, 12, '???', "素じゃ！"),
    0x001D7ED4: Data(DataType.String, 16, 'True self?', "ホンマの自分？"),
    0x001D7EE4: Data(DataType.String, 12, '???', "何が悪い？"),
    0x001D7EF0: Data(DataType.String, 12, 'You\'re wrong!', "ちがう！"),
    0x001D7EFC: Data(DataType.String, 24, '???', "それがどないしてん！"),
    0x001D7F14: Data(DataType.String, 16, '???', "ちゃうわい！"),
    0x001D7F24: Data(DataType.String, 20, '???', "演じる、って何や？"),
    0x001D7F38: Data(DataType.String, 12, 'And that is?', "それが？"),
    0x001D7F44: Data(DataType.String, 16, '???', "アカン事かも…"),
    0x001D7F54: Data(DataType.String, 16, '???', "なんとも思わん"),
    0x001D7F64: Data(DataType.String, 16, '???', "しゃあないやん"),
    ...
    0x001D7FD0: Data(DataType.String, 20, '???', "そんなん知らんわ"),
    0x001D7FE4: Data(DataType.String, 8, '???', "脱ぐ"),
    0x001D7FEC: Data(DataType.String, 12, '???', "脱がへん"),
    ...
    0x001D8070: Data(DataType.String, 20, '???', "そんなつもりないよ"),
